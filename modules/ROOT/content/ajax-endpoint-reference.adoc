...
For details on setting the properties for an Ajax endpoint using an XML editor, see the xref:transports/ajax-transport-reference.adoc[Ajax Transport Reference] discussion in the Mule ESB User Guide.