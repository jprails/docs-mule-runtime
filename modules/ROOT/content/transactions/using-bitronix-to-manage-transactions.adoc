...
This document assumes you are familiar with working with xref:3.7@shared-resources/domain-project-shared-resources.adoc[Shared Resources] in Mule.
...
Bitronix integration provides a datasource connection pool for the xref:3.6@connectors::database-connector.adoc[Database connector], which you must use whenever you want to implement resource pooling in the database connector.
...
* Read more about how to xref:shared-resources/domain-project-shared-resources.adoc[define a Bitronix transaction manager as a shared resource] for multiple applications associated with a domain.