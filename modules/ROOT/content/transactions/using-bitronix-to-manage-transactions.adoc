...
Bitronix integration provides a datasource connection pool for the xref:3.8@connectors::database-connector.adoc[Database connector], which you must use whenever you want to implement resource pooling in the database connector.
