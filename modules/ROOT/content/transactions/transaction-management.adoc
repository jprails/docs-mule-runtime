...
+
image::transactions/transactions-panel.png[transactions_panel]
...
xref:transactions/single-resource-transactions.adoc[Single Resource Transaction] for details.
|XA Transaction a|Apply a transaction to a flow which involves multiple resources: JMS, VM or JDBC. See xref:transactions/xa-transactions.adoc[XA Transaction] for details.
|Multi Transaction |Apply a transaction to a flow which involves multiple resources: JMS or VM. See xref:transactions/multiple-resource-transactions.adoc[Multiple Resource Transaction] for details.
...
+
image::transactions/add-blocks.png[add_blocks]
...
* If you apply an XA transaction to a JMS inbound endpoint in your flow, you have the option of specifying the polling frequency of the queue. Access xref:transactions/xa-transactions.adoc[XA Transactions] for configuration details.
...
+
image::transactions/exception-strategy.png[exception_strategy]
...
* Read more about xref:transactions/single-resource-transactions.adoc[Single Resource Transactions], Multiple Resource Transaction, and xref:transactions/xa-transactions.adoc[XA Transactions].
