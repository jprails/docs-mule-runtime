...
:page-aliases: transaction-management.adoc
...
|xref:3.6@transactions/single-resource-transactions.adoc[Single Resource Transactions] a|
...
|xref:3.7@transactions/multiple-resource-transactions.adoc[Multiple Resource Transactions] a|
...
|xref:3.7@transactions/xa-transactions.adoc[XA Transactions] a|
* Receives or sends messages to more than one resource.
...
+
image::transactions/jms-transaction.png[jms_transaction]
...
Use xref:3.6@transactions/transactions-configuration-reference.adoc[Transactions Configuration Reference] for quick access to attribute configurations.
...
+
image::transactions/transactional1.png[]
+
...
Apply a transaction to a flow that involves a single resource. See xref:3.6@transactions/single-resource-transactions.adoc[Single Resource Transaction] for details.
|XA Transaction |Apply a transaction to a flow that involves multiple resources: JMS, VM or JDBC. See xref:3.7@transactions/xa-transactions.adoc[XA Transaction] for details.
|Multi Transaction |Apply a transaction to a flow that involves multiple resources: JMS or VM. See xref:3.7@transactions/multiple-resource-transactions.adoc[Multiple Resource Transaction] for details.
...
+
image::transactions/transactional2.png[]
...
* If you apply an XA transaction to a JMS inbound connector in your flow, you have the option of specifying the polling frequency of the queue. Access xref:3.7@transactions/xa-transactions.adoc[XA Transactions] for configuration details.
...
Refer to the xref:3.7@error-handling.adoc[Error Handling] documentation to learn more about Mule's default exception strategy and how to apply exception strategies to flows. Follow the steps below to apply an exception strategy to an individual transaction.
...
+
image::transactions/transactional3.png[]

. Configure the exception strategy as needed, keeping in mind Mule uses this exception strategy to handle any exceptions thrown while processing the transaction. Reference the xref:3.7@error-handling.adoc[Error Handling] documentation for exception strategy configuration details.
...
* Read more about xref:3.6@transactions/single-resource-transactions.adoc[Single Resource Transactions], xref:3.7@transactions/multiple-resource-transactions.adoc[Multiple Resource Transactions], and xref:3.7@transactions/xa-transactions.adoc[XA Transactions].
* Read more about xref:3.7@error-handling.adoc[Exception Strategies].
...
* Use the xref:3.6@transactions/transactions-configuration-reference.adoc[Transactions Configuration Reference] for quick reference to transactional attributes.