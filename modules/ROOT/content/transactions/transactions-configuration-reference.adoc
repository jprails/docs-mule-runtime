...
This page provides reference information on the elements you configure for transactions. For more information on transactions, see xref:transactions/transaction-management.adoc[Transaction Management].
