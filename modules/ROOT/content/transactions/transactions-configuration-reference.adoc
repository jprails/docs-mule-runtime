...
:page-aliases: transactions-configuration-reference.adoc

[%header%autowidth.spread]
|===
|image:transactions/information.png[] |*Using Transactions in Flows* +

This page provides *reference information* on the elements you configure for transactions. +
For more information on how to configure transactions in flows, see xref:transactions/transaction-management.adoc[Transaction Management].
|===
