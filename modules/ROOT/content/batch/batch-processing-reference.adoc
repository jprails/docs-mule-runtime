...
[NOTE]
 For a *full description* of the example and steps the batch job takes in each phase of processing, see xref:batch/batch-processing.adoc[Batch Processing].
...
* Learn xref:batch/using-mel-with-batch-processing.adoc[MEL expressions you can use in Batch jobs] to simplify error handling

* Review the xref:batch/batch-processing.adoc[basic anatomy] of batch processing in Mule.