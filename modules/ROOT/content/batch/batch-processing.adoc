...
To build applications with Batch jobs and run them in a test or production environment, you must build the application with an Enterprise runtime. Learn more about xref:5@studio::mule-runtime/changing-runtimes-in-studio.adoc[Changing Runtimes in Studio].
====
...
* Anypoint Studio. See xref:5@studio::index.adoc[Anypoint Studio Essentials] chapter to learn more about developing with Mule ESB's graphical user interface.
* xref:3.7@connectors::index.adoc[Anypoint Connectors].
* xref:5@studio::datamapper/datamapper-user-guide-and-reference.adoc[Anypoint DataMapper User Guide and Reference]
...
. The application first uses a xref:3.7@connectors::file-connector.adoc[File connector] to upload a CSV file, then uses a xref:5@studio::datamapper/datamapper-concepts.adoc[DataMapper] to convert the data format into a collection (see mapping below). Each item in the collection represents a lead. Each lead contains a company name, a first name, a last name, a birthday and an email address.
+
...
image::batch/batch-example-filter.png[batch-example-filter.png]
=====
...
* xref:3.7@mule-management-console::index.adoc[Mule Management Console (MMC) ]does not support visibility into batch processing.
...
* Read more about xref:cloudhub::cloudhub-fabric.adoc[CloudHub support for batch processing].
* Learn more about xref:3.7@connectors::index.adoc[Anypoint Connectors].
* Learn more about xref:scopes/poll-reference.adoc[Polling and Watermarks].
* Learn more about xref:5@studio::datamapper/datamapper-user-guide-and-reference.adoc[DataMapper].