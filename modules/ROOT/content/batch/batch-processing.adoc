...
* xref:batch/batch-processing-reference.adoc[reference details]

* xref:batch/batch-processing-reference.adoc[attributes]

* xref:batch/batch-filters-and-batch-commit.adoc[filters]

* xref:batch/batch-filters-and-batch-commit.adoc[batch commit]
* xref:batch/record-variable.adoc[record-level variables]
* xref:batch/batch-processing-reference.adoc[MEL expressions]

* xref:cloudhub::cloudhub-fabric.adoc[CloudHub support for batch processing]

* xref:3.6@connectors::index.adoc[Anypoint Connectors]

* xref:scopes/poll-reference.adoc[Polling and Watermarks]

* xref:6@studio::datamapper/datamapper-user-guide-and-reference.adoc[DataMapper]
