...
:page-aliases: using-mel-with-batch-processing.adoc
:keywords: anypoint studio, studio, mule esb, batch

All of the functions and attributes below are usable within xref:mel/mule-expression-language-mel.adoc[MEL] expressions anywhere in Mule where the context makes sense.
...
image::batch/batch-function1.png[batch+function1]

Here you can add the following expression into the Set Payload transformer:

image::batch/batch-function2.png[batch+function2]
