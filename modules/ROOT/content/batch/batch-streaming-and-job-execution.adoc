...
:page-aliases: batch-streaming-and-job-execution.adoc
...
image::batch/example-actions.png[example_actions]
...
image::batch/batch-commit-stream.png[batch_commit_stream]
...
a|
image::batch/ordered-seq.png[ordered_seq]
...
image::batch/round-robin.png[round_robin]
...
image::batch/sfdc-to-scv-streaming.png[sfdc_to_scv_streaming]
...
* Access the xref:3.6@batch/batch-processing.adoc[full documentation for Batch Processing] for the latest general availability release of Mule.

* For more information on best design-time practices with DataSense and DataMapper, consult the xref:5@studio::datasense/datasense.adoc[DataSense documentation].