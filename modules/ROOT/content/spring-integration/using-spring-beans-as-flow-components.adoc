...
For more information on component configuration, see xref:components/configuring-components.adoc[Configuring Components]. For more information on the elements you use to configure components, see xref:components/component-configuration-reference.adoc[Component Configuration Reference].
