...
:page-aliases: using-spring-beans-as-flow-components.adoc
...
For more information on component configuration, see xref:3.7@components/configuring-components.adoc[Configuring Components]. For more information on the elements you use to configure components, see xref:3.6@components/component-configuration-reference.adoc[Component Configuration Reference].
