...
The inbound endpoints can be any valid xref:endpoints/endpoint-configuration-reference.adoc[Mule Endpoint], so you can receive JMS messages, SOAP requests, files, HTTP and servlet requests, TCP, multicast, and more.
