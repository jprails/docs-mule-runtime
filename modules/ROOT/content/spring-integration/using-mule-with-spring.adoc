...
xref:3.8@about/xml-configuration-file.adoc[About the XML Configuration File]
...
[TIP]
See xref:3.8@spring-integration/spring-application-contexts.adoc[Spring Application Contexts]
...
xref:3.8@spring-integration/using-spring-beans-as-flow-components.adoc[Using Spring Beans as Flow Components]
