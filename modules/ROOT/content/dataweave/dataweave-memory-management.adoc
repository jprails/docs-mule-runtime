...
:page-aliases: dataweave-streaming.adoc, dataweave-memory-management.adoc
...
image::dataweave/dataweave-memory-management-541a1.png[]
...
image::dataweave/dataweave-memory-management-dc180.png[]
