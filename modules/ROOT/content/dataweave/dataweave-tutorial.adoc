...
:page-aliases: dataweave-tutorial.adoc
...
For more advanced examples written directly in DataWeave code, see xref:dataweave/dataweave-examples.adoc[DataWeave Examples].
...
+
image::dataweave/add-metadatadw.png[]
...
+
image::dataweave/ex2outputdw.png[]

. Drag a xref:3.7@connectors::web-service-consumer.adoc[Web Service Consumer] to your flow. Create a global configuration for it by clicking the green plus sign in its properties editor. In the *WSDL Location* field, paste the following URL: **http://tshirt-service.cloudhub.io/?wsdl**.  Note that all of the other fields in the configuration element are completed automatically when you do this. Then click *Ok*.
...
+
image::dataweave/ex2inputexpecteddw.png[]
...
+
image::dataweave/ex2-flowdw.png[]
...
+
image::dataweave/dw-mapping-tut1.png[mapping]
...
+
image::dataweave/dw-tut1-fixed-vals.png[fixed vals]
...
+
image::dataweave/dw-buttons.png[preview]
...
+
image::dataweave/ex3-metadatadw.png[]
...
image::dataweave/ex3-flowdw.png[]
...
* See our xref:dataweave/dataweave-reference-documentation.adoc[DataWeave Reference Documentation]
* See more advanced examples in xref:dataweave/dataweave-examples.adoc[DataWeave Examples]
* Migrate your old DataMapper components automatically using xref:dataweave/dataweave-migrator.adoc[DataWeave Migrator Tool]