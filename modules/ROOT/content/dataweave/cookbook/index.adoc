...
| xref:dataweave/cookbook/perform-basic-transformation.adoc[Perform Basic Transformation] | Uses selectors to perform a basic format transformation. It does not use any functions.
...
| xref:dataweave/cookbook/change-value-of-a-field.adoc[Changing the Value of a Field]
...
| xref:dataweave/cookbook/parse-dates.adoc[Parsing Dates]
