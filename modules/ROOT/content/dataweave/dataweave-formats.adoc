...
|`Collections/Array/Iterator/Iterable` | xref:dataweave/dataweave-types.adoc#array[Array]
|`String/CharSequence/Char/Enum/Class` | xref:dataweave/dataweave-types.adoc#string[String]
|`int/Short/Long/BigInteger/Flat/Double/BigDecimal`|xref:dataweave/dataweave-types.adoc#number[Number]
|`Calendar/XmlGregorainCalendar`|xref:dataweave/dataweave-types.adoc#datetime[Datetime]
|`TimeZone`|xref:dataweave/dataweave-types.adoc#timezone[Timezone]
|`sql.Date/util.Date`|xref:dataweave/dataweave-types.adoc#date[Date]
|`Bean/Map`|xref:dataweave/dataweave-types.adoc#object[Object]
|`InputStream/Array[Byte]`|xref:dataweave/dataweave-types.adoc#binary[Binary]
|`java.lang.Boolean`|xref:dataweave/dataweave-types.adoc#boolean[Boolean]
...
[TIP]
====
For Anypoint Studio see xref:6@studio::transform-message/input-output-structure-transformation-studio-task.adoc[To Define Input and Output Structure of a Transformation (Anypoint Studio)].

For Design Center see xref:1.0@design-center::input-output-structure-transformation-design-center-task.adoc[To Define Input and Output Structure of a Transformation (Design Center)].
====
== CSV
...
To set this via the Anypoint Studio UI, see xref:6@studio::transform-message/input-output-structure-transformation-studio-task.adoc[To Define Input and Output Structure of a Transformation].
...
+
image::dataweave/dataweave-formats-4a556.png[]
...
image::dataweave/dataweave-formats-exceltable.png[]
...
+
image::dataweave/dataweave-formats-excel-metadata.png[]
...
[TIP]
====
See xref:dataweave/dataweave-flat-file-schemas.adoc[DataWeave Flat File or EDI Schemas] for instructions and examples on how to create the required schema file.
====
...
+
image::dataweave/dataweave-formats-27b3c.png[]
...
[TIP]
See xref:dataweave/dataweave-flat-file-schemas.adoc[Flat File Schemas] for more detailed instructions on how to write the required schema.
