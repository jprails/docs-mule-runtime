...
:page-aliases: dataweave-formats.adoc
...
[TIP]
See xref:6@studio::transform-message/input-output-structure-transformation-studio-task.adoc[To Define Input and Output Structure of a Transformation].
...
image::dataweave/dataweave-formats-580be.png[]
...
image::dataweave/dataweave-formats-excell-reader.png[]
...
image::dataweave/dataweave-formats-6e5e4.png[]
