...
* Used by Mule as its security provider via https://www.mulesoft.org/docs/site/current/apidocs/org/mule/module/acegi/AcegiProviderAdapter.html[AcegiProviderAdapter]
* Used by Acegi/Spring to perform xref:component-authorization-using-acegi.adoc[Component Authorization]

For information on configuring an in-memory DAO provider, see xref:security/configuring-security.adoc[Configuring Security].
