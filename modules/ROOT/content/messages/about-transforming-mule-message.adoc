...
:page-aliases: message-state.adoc
...
image::messages/message-state.png[message+state]
...
image::messages/payload2.png[]

image::messages/keyvaluepair.png[keyValuePair]

==== Properties

As Mule message processors cannot add, remove or act upon *inbound properties*, none has changed.

image::messages/inbound2.png[]

The Transform Message component did not set, remove or copy any *outbound properties* on the message.

image::messages/outbound2.png[]

==== Variables

The Transform Message component did not add or remove any *Variables* or *Session Variables*.

image::messages/variables2.png[]

image::messages/session2.png[]

== More Examples

=== Setting a Variable on a Message

The xref:transformers/variable-transformer-reference.adoc[Variable transformer] in a flow sets the payload of the message as a minPrice variable on the message. Recall that the Message Processor item indicates the next message processor in the flow that the message will encounter.
...
image::messages/beforevariable.png[beforeVariable]

AFTER +

image::messages/aftervariable.png[afterVariable]

=== Setting a Property on a Message

The  xref:transformers/property-transformer-reference.adoc[Property transformer] in a flow sets the payload of the message as a `size` property on the message.
...
image::messages/beforeproperty.png[beforeProperty]

AFTER

image::messages/afterproperty.png[afterProperty]

=== Setting a Payload on a Message

The  xref:transformers/set-payload-transformer-reference.adoc[Set Payload transformer]  in a flow replaces the payload of the message with the string `Hello, World.`

BEFORE

image::messages/beforesetpayload.png[beforeSetPayload]

AFTER

image::messages/aftersetpayload.png[afterSetPayload]
