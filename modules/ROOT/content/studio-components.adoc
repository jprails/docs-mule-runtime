...
|image:echo-24x16.png[Echo-24x16] |Echo |Outputs the message being processed to a log or display, then passes the message to the next building block in the flow. |xref:components/echo-component-reference.adoc[Echo Component Reference]
...
|image:logger-24x16.png[Logger-24x16] |Logger |Logs custom strings, including strings constructed from embedded expressions. Also allows specification of logging level and category. |xref:components/logger-component-reference.adoc[Logger Component Reference]
|===
...
|===
|  |Components |Description |Documentation
|image:groovy-component-24x16.png[] |Groovy |Facilitates the integration of a custom script backed by the Groovy script engine. |xref:components/groovy-component-reference.adoc[Groovy Component Reference]


|image:java-component-24x16.png[] |Java |Allows you to select a Java class to be invoked by the application flow. |xref:components/java-component-reference.adoc[Java Component]

|image:javascript-component-24x16.png[]
|JavaScript
|Allows integration of a custom script backed by the JavaScript engine.
|xref:3.7@components/javascript-component-reference.adoc[JavaScript Component Reference]


|image:python-component-24x16.png[] |Python |Allows integration of a custom script backed by the Python script engine. |xref:components/python-component-reference.adoc[Python Component Reference]

|image:ruby-component-24x16.png[]
|Ruby
...
|image:component-24x16.png[Component-24x16] |Script |Makes a script written in Groovy, JavaScript, Python, or Ruby available to the application flow. |xref:components/script-component-reference.adoc[Script Component Reference]
|===
...
|===
|  |Components |Description |Documentation
|image:rest-24x16.png[Rest-24x16] |REST |Makes a REST web service available to the application flow via Jersey. |xref:components/rest-component-reference.adoc[REST Component Reference]
