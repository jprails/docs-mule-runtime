...
* *NEXT STEP*: Read on about link:/mule-user-guide/v/4.0/mule-components[components].
* Skip ahead to understand the structure of a xref:concepts/index.adoc#mule-event[Mule Event object].