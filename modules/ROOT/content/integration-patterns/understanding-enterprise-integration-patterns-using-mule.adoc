...
|File Transfer |xref:3.6@transports/file-transport-reference.adoc[File Transport]
|Shared Database |xref:3.6@transports/jdbc-transport-reference.adoc[JDBC Transport]
...
|Message Router |xref:3.6@routers/routers.adoc[Message Routers]
|Message Translator |xref:3.6@transformers/using-transformers.adoc[Message Transformer]
|Message Endpoint |Inbound & Outbound xref:3.6@endpoints/endpoint-configuration-reference.adoc[Endpoints]
|===
...
|===
|Pattern |Mapping to a Mule Object
|Content Enricher |xref:3.6@scopes/message-enricher.adoc[Message Enricher]
|===
