...
This document assumes that you are familiar with Mule, xref:3.5@connectors::index.adoc[Anypoint Connectors], and the xref:5@studio::basic-studio-tutorial.adoc[Anypoint Studio Essentials]. To increase your familiarity with Studio, consider completing one or more xref:5@studio::basic-studio-tutorial.adoc[Anypoint Studio Tutorials]. Further, this page assumes that you have a basic understanding of xref:concepts/index.adoc[Mule flows] and xref:global-elements.adoc[Mule Global Elements].

*http://mulesoft.github.io/cassandra-connector/1.2.2/mule/cassandradb-config.html[Cassandra Connector API]*
...
* Learn more about working with xref:3.7@connectors::index.adoc[Anypoint Connectors].
