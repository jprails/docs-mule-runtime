...
Take a look at xref:using-mule-configuration-patterns.adoc[configuration patterns] and xref:flows/using-flows-for-service-orchestration.adoc[flows].
...
For more information about patterns, read the xref:mule-configuration/general-configuration-reference.adoc[General Configuration Reference]
