...
. _Optional_: xref:5@studio::mule-runtime/adding-community-runtime.adoc[Add Community runtime] to your Mule Studio instance.
...
* xref:3.4@connectors::index.adoc[Anypoint Connectors]
...
* Access a list of all the xref:5@studio::install-update-items-in-studio.adoc[update sites] available for your version of Mule Studio.