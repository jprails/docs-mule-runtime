...
This document assumes you are familiar with xref:mel/mule-expression-language-mel.adoc[Mule Expression Language (MEL)], and that you are using Mule 3.4.0 or later.
