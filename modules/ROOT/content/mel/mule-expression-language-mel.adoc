...
This document assumes that you are familiar with Mule ESB and its xref:concepts/index.adoc[basic concepts]. Consider reading the chapter, xref:general:getting-started:index.adoc[Anypoint Fundamentals] to gain familiarity before proceeding.
...
* Learn better by tutorial? Access the xref:3.8@messages/mule-message.adoc[Mule Message Tutorial].
