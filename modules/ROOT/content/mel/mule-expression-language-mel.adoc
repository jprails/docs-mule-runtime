...
:page-aliases: mule-expression-language-mel.adoc
...
This document assumes that you are familiar with Mule and its xref:concepts/index.adoc[basic concepts]. Consider reading the chapter, xref:general:getting-started:index.adoc[Anypoint Fundamentals] to gain familiarity before proceeding.
...
* *NEXT STEP*: Learn the xref:mel/mule-expression-language-basic-syntax.adoc[basic syntax of MEL], or dive into xref:flows/index.adoc[Mule Application Architecture].
* Learn better by example? Access our collection of xref:mel/mule-expression-language-examples.adoc[example apps which use MEL].
* Learn better by tutorial? Access the xref:messages/mule-message.adoc[Mule Message Tutorial].
...
* Learn how to take advantage of DataWeave within MEL with xref:mel/mel-dataweave-functions.adoc[MEL DataWeave Functions]