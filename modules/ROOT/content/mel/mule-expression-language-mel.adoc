...
image::mel/expression.png[Expression]
...
A choice exception strategy is a way of deciding which way to route a message that must deviate from the normal processing path. Choice exception strategies use MEL expressions. For more information, click xref:exceptions/choice-exception-strategy.adoc[here]
...
image::mel/downloadssorterflow.png[]
...
image::mel/expressiontransformer.png[Expressiontransformer]
...
image::mel/httptwitterflow.png[]

image::mel/patternpropertiestwitter.png[]
...
image::mel/endpoint-properties.png[]
...
image::mel/expression-icon.png[]

image::mel/expression-properties.png[]
