...
This reference page provides lists and brief explanations of the date and time functions in MEL. For explanatory information, see xref:mel/mule-expression-language-mel.adoc[Mule Expression Language], xref:mel/mule-expression-language-basic-syntax.adoc[MEL Basic Syntax], and the MEL examples.

== Assumptions

This document assumes you are familiar with xref:mel/mule-expression-language-mel.adoc[Mule Expression Language (MEL)].  Further, this document assumes you are using Mule 3.4.0 or later.
