...
This reference page provides lists and brief explanations of the date and time functions in MEL. For explanatory information, see xref:mel/mule-expression-language-mel.adoc[Mule Expression Language], xref:mel/mule-expression-language-basic-syntax.adoc[MEL Basic Syntax], and the xref:mel/mule-expression-language-examples.adoc[MEL examples].
