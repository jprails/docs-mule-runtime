...
:page-aliases: mel-cheat-sheet.adoc
...
See also xref:mel/mule-expression-language-reference.adoc[Mule Expression Language Reference].
...
For more information, see xref:modules/xpath.adoc[XPath] and
xref:mel/mule-expression-language-reference.adoc#xpath[MEL XPath].
...
Quick access to the MVEL 2.0 Documentation: https://github.com/mvel/mvel[MVEL in Git] and
https://en.wikisource.org/wiki/MVEL_Language_Guide[MVEL Wikisource].
