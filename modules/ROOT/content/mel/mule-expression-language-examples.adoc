...
:page-aliases: mule-expression-language-examples.adoc
...
This document assumes you are familiar with Mule Expression Language's xref:mel/mule-expression-language-basic-syntax.adoc[basic syntax] and are comfortable building and running Mule applications using xref:6@studio::index.adoc[Mule Studio] or XML.

If you aren't yet familiar with how to access information about the Mule messages that pass through your applications, consider following this xref:messages/mule-message.adoc[tutorial], which walks you through both examining your Mule message and its data structure and writing simple MEL expressions.
...
+
image::mel/greeting-flow.png[greeting+flow]
+
...
[source,xml,linenums]
----
include::{samplesdir}/mule-expression-language-examples_1.xml[]
----
+
. Save and run the project.
...
[source,xml,linenums]
----
include::{samplesdir}/mule-expression-language-examples_2a.xml[]
----
+
. The full code of your flow should look like this:
+
[source,xml,linenums]
----
include::{samplesdir}/mule-expression-language-examples_2b.xml[]
----
+
. Save and run the project.
. Through a browser, access the URL `http://localhost:8081/greet1?username=yourName`
...
[source,xml,linenums]
----
include::{samplesdir}/mule-expression-language-examples_3.xml[]
----
+
...
+
image::mel/greeting-5.png[greeting+5]
+
...
[source,xml,linenums]
----
include::{samplesdir}/mule-expression-language-examples_5.xml[]
----
+
...
+
image::mel/greeting-6.png[greeting+6]
+
...
[source,xml,linenums]
----
include::{samplesdir}/mule-expression-language-examples_6.xml[]
----
+
...
[NOTE]
Note that this project is configured specifically for the *Mule 3.6.0 runtime* and newer. Refer to the xref:3.5@mel/mule-expression-language-examples.adoc[Mule Expression Language Examples - 3.5] documentation for a 3.5.X compatible version.

[source,xml,linenums]
----
include::{samplesdir}/mule-expression-language-examples_all.xml[]
----

== See Also

* Access the Mule Expression Language xref:mel/mule-expression-language-reference.adoc[Reference] and xref:mel/mule-expression-language-tips.adoc[Tips].
* Want to learn more about how to get information about the Mule message so that you can work with it using MEL? Try out this xref:messages/mule-message.adoc[tutorial].