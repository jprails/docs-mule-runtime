...
You can expose a manager's logging configuration over JMX by configuring a Log4J Jmx agent in your Mule configuration file. See xref:administer/jmx-management.adoc[JMX Management] for more information.