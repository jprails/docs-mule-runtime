...
:page-aliases: testing-strategies.adoc
...
Mule provides abstract parent classes to help with unit testing. Turn xref:testing/unit-testing.adoc[here] for more information about them.
...
The FTC supports plenty of configuration options. Read more about it there: xref:testing/functional-testing.adoc[Functional Testing].
