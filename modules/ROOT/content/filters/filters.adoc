...
|image:filters/filter-24x16.png[Filter-24x16] |Custom |References a user-implemented filter class. |xref:filters/custom-filter.adoc[Custom Filter Reference]
...
|image:filters/filter-24x16.png[Filter-24x16] |Schema Validation |Uses the JAXP libraries, to validate a message against a schema. |xref:filters/schema-validation-filter.adoc[Schema Validation Filter Reference]
...
image::filters/filter-general.png[Filter+General]
