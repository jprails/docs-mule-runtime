...
image::filters/add-filter.png[Add-filter]
...
* For more information about the And Filter, see xref:filters/filters-configuration-reference.adoc[here].
* For more information about the Not Filter, see xref:filters/filters-configuration-reference.adoc[here].
* For more information about the Or Filter, see xref:filters/filters-configuration-reference.adoc[here].