...
:page-aliases: message-property-filter.adoc
...
You can also limit the filter to the scope of the message. The default scope is outbound. For more information about message scopes, see xref:concepts/index.adoc[Mule Concepts].

For more information on using a Message Property Filter, see xref:using-filters.adoc[here].

== Mule ESB Reference

For more information about Message Property Filter, see xref:filters/filters-configuration-reference.adoc[here].