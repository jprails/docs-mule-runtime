...
image::scopes/asynch-schematic.png[Asynch+Schematic]
...
By default, the following icon appears in the upper left corner of the Async scope’s title bar: image:scopes/asynch-title.png[Asynch+Title] . Double-click anywhere on the title bar to open the Properties pane.
...
image::scopes/asynch-properties.png[Asynch+Properties]
...
+
image::scopes/asynch-list.png[Asynch+List]
