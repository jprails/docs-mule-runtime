...
An async scope is similar to an xref:3.7@flows/flows-and-subflows.adoc[asynchronous flow] in that:
...
An async scope is similar to a xref:3.7@flows/flows-and-subflows.adoc[subflow] in that it inherits the exception strategy of the main flow.
...
+
image::scopes/async-2.png[async+2]
+
...
+
image::scopes/async-scope.png[async_scope]
...
For more information about processing strategies, see xref:3.7@flows/flow-processing-strategies.adoc[Flow Processing Strategies].
...
. Click the image:scopes/add.png[(plus)] to the right of the *Processing Strategy* field.  +
...
. Configure the processing strategy as needed. For more information, see xref:3.7@flows/flow-processing-strategies.adoc[Flow Processing Strategies].

[discrete.view]
=== Studio or Standalone XML

. Define your processing strategy as a global element, with any necessary configuration or optional fine-tuning. (For more information, see xref:3.7@flows/flow-processing-strategies.adoc[Flow Processing Strategies].) Refer to code sample below.
...
* For more information about processing strategies and how to configure them, see xref:3.7@flows/flow-processing-strategies.adoc[Flow Processing Strategies].