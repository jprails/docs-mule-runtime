...
See xref:object-store::mule-object-stores.adoc[Mule Object Stores] for further information about object stores in Mule. The following code sample illustrates how to configure an in-memory store:
...
+
image::scopes/configure-threading.png[Configure Threading Profile]
+
[%header,cols="30a,70a"]
|===
|Attribute |Description
...
image::scopes/until-successful-xml-example-pt1.png[]

image::scopes/until-successful-xml-example-pt2.png[]
