...
== image:scopes/cache-icon.png[cache_icon] Overview
...
+
image::scopes/cache-drag.png[cache_drag]

. Double-click the properties icon to open the Scope Properties panel.
+
image::scopes/cache-properties.png[cache_properties]
...
+
image::scopes/select-object-store.png[select_object_store]
+
[%header,cols="20,75a"]
|===
...
+
image::scopes/cache-example.png[cache_example]
