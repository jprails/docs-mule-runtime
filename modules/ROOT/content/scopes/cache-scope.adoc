...
By default, Mule stores all cached responses in an InMemoryObjectStore. <<ccs,Create a Caching Strategy>> and define a new xref:object-store::mule-object-stores.adoc[object store] if you want to customize the way Mule stores cached responses.
