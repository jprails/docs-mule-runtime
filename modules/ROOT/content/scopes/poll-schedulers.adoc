...
This document assumes that your are familiar with xref:6@studio::index.adoc[Anypoint Studio] and http://en.wikipedia.org/wiki/Polling_(computer_science)[polling] in general.  Read more about xref:scopes/poll-reference.adoc[poll scopes] in Mule.
...
* Learn more about xref:scopes/poll-reference.adoc[Poll Scopes] in Mule.
* Reference xref:mel/mule-expression-language-mel.adoc[Mule Expression Language MEL].
* Learn more about xref:mel/mule-expression-language-date-and-time-functions.adoc[MEL Date and Time Functions].