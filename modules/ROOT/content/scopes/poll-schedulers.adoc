...
:page-aliases: poll-schedulers.adoc
...
This document assumes that your are familiar with xref:6@studio::index.adoc[Anypoint Studio] and http://en.wikipedia.org/wiki/Polling_(computer_science)[polling] in general.  Read more about xref:3.6@scopes/poll-reference.adoc[poll scopes] in Mule.
...
image::scopes/poll-scheduler.png[poll_scheduler]
...
image::scopes/cron-scheduler.png[cron_scheduler]
...
* Learn more about xref:3.6@scopes/poll-reference.adoc[Poll Scopes] in Mule.
* Reference xref:3.7@mel/mule-expression-language-mel.adoc[Mule Expression Language MEL].
* Learn more about xref:3.6@mel/mule-expression-language-date-and-time-functions.adoc[MEL Date and Time Functions].