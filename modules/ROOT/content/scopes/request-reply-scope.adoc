...
This document assumes that you understand the difference between xref:flows/flows-and-subflows.adoc[synchronous and asynchronous flows]. Furthermore, you're also familiar with xref:scopes/scopes.adoc[Scopes] in general.
...
image::scopes/request-reply-scope-1.png[]
...
image::scopes/req-rep-config.png[]
...
image::scopes/request-response-2.png[]
...
* Learn more about xref:flows/flows-and-subflows.adoc[synchronous and asynchronous flows].