...
This document assumes that you understand the difference between xref:flows/flows-and-subflows.adoc[synchronous and asynchronous flows]. Furthermore, review xref:scopes/scopes.adoc[Scopes] in general.
