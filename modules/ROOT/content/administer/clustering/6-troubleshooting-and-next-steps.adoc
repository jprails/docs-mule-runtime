...
* For more information about Mule clustering, consult the xref:3.7@mule-management-console::configuring-mule-ha-clustering.adoc[Mule HA Clustering] documentation.
