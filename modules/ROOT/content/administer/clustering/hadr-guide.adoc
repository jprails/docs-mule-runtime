...
image::administer/clustering/hadr-cluster.png[]
...
* xref:3.8@mule-management-console::defining-slas-and-alerts.adoc[Defining SLAs and Alerts]
...
|image:administer/clustering/hadr-cold-standby.png[]
...
|===
|Diagram |Description |Downtime
|image:administer/clustering/hadr-warm-standby.png[]
...
|===
|Diagram |Description |Downtime
|image:administer/clustering/hadr-active-passive.png[]
...
|===
|Diagram |Description |Downtime
|image:administer/clustering/hadr-active-active1.png[]
...
|image:administer/clustering/hadr-active-active2.png[]
...
image::administer/clustering/hadr-aa-clustering.png[]
...
image::administer/clustering/hadr-fault-tolerant.png[]
...
|image:administer/clustering/hadr-zero-downtime-1.png[]

|Confidence in the new environment continues to increase and more traffic is routed to it.
|image:administer/clustering/hadr-zero-downtime-2.png[]

|All traffic has been routed to the new environment.
|image:administer/clustering/hadr-zero-downtime-3.png[]
...
|image:administer/clustering/hadr-zero-downtime-4.png[]
|===
...
image::administer/clustering/hadr-aws-global-infrastructure.png[]
...
image::administer/clustering/hadr-am-web-services.png[]
...
image::administer/clustering/hadr-load-balancer.png[]
