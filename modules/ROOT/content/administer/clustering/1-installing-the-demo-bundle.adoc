...
:page-aliases: 1-installing-the-demo-bundle.adoc
...
. Download the https://s3.amazonaws.com/seteam/HA_DEMO/mule-ha-bundle-3.0.zip[*Mule HA Demo Bundle - mule-ha-bundle-3.0.zip*]
+
[CAUTION]
====
...
+
image::administer/clustering/mule-is-kicking.png[mule_is_kicking]
...
* https://www.mulesoft.com/platform/anypoint-management-center[Anypoint Management Center]
