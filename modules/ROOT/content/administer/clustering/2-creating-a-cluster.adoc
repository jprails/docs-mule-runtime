...
. The Management Console displays a *Mule ESB Enterprise - Quick Start* screen click the image:administer/clustering/error.png[] in the upper right corner to close.
...
* xref:administer/clustering/3-deploying-an-application.adoc[Next: Deploying an Application >>]