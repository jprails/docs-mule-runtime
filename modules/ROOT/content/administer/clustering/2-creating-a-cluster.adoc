...
. The management console displays a *Mule ESB Enterprise - Quick Start* screen; click the red X icon image:administer/clustering/red-x-icon.png[] in the upper-right corner to close.
