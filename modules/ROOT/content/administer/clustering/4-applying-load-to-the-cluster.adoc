...
:page-aliases: 4-applying-load-to-the-cluster.adoc
...
+
image::administer/clustering/widgetui-home.png[widgetUI_home]
...
+
image::administer/clustering/application-flows.png[application_flows]
+
* The *Throughput* pane displays the average number of messages the Mule cluster processes each second.
+
image::administer/clustering/before-throughput.png[before_throughput]
+
[NOTE]
...
+
image::administer/clustering/before-amountofflows.png[before_amountofFlows]
+
...
+
image::administer/clustering/before-flowanalysis.png[before_flowAnalysis]
+
...
+
image::administer/clustering/before-timetocomplete.png[before_timeToComplete]
...
+
image::administer/clustering/control-panel.png[control_panel]
...
+
image::administer/clustering/after-throughput.png[after_throughput]
...
image::administer/clustering/after-amountofflows.png[after_amountofFlows]
...
image::administer/clustering/after-flowanalysis.png[after_flowAnalysis]
...
+
image::administer/clustering/after-timetoprocess3.png[after_TimetoProcess3]