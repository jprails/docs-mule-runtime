...
:page-aliases: choosing-the-right-clustering-topology.adoc
...
|image:administer/clustering/ha-arch.png[HA-arch]
...
image::administer/clustering/jms-queues.png[]
...
image::administer/clustering/http-and-jms.png[http_and_jms]
