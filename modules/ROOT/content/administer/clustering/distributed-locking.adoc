...
* Access xref:administer/clustering/mule-high-availability-ha-clusters.adoc[Mule High Availability (HA) Clustering] for an overview.

* Learn how to xref:administer/clustering/creating-and-managing-a-cluster-manually.adoc[manually create and manage a cluster,] accessing additional options.

* Learn how to enable xref:administer/clustering/distributed-file-polling.adoc[distributed file polling].