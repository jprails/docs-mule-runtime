...
Some endpoints, such as the xref:3.6@connectors::file-connector.adoc[File Endpoint] or xref:3.6@connectors::ftp-connector.adoc[FTP Endpoint], regularly poll directories and read certain files as they are created in the directories polled. These files may reside on a remote file system, including file systems of nodes belonging to a xref:administer/clustering/mule-high-availability-ha-clusters.adoc[Mule High Availability (HA) Cluster].
...
* xref:3.6@connectors::file-connector.adoc[File Endpoint]
* xref:3.6@connectors::ftp-connector.adoc[FTP Endpoint]
* xref:3.6@connectors::sftp-connector.adoc[SFTP Endpoint]
...
[TIP]
====
You can create and configure clusters with the graphical interface available in the xref:3.3@mule-management-console::index.adoc[Mule Management Console], or manually by xref:3.6@mule-management-console::creating-or-disbanding-a-cluster.adoc[editing the cluster configuration file.] For additional configuration options, including cluster network parameters, see xref:administer/clustering/creating-and-managing-a-cluster-manually.adoc[Creating and Managing a Cluster Manually].
====