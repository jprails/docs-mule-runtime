...
This page describes manual creation and configuration of a cluster. If you want to create and manage a cluster using the Management Console's graphical interface, see xref:3.6@mule-management-console::creating-or-disbanding-a-cluster.adoc[Creating or Disbanding a Cluster].
