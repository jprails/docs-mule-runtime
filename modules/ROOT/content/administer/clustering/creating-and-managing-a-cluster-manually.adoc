...
This page describes manual creation and configuration of a cluster. If you want to create and manage a cluster using the Management Console's graphical interface, see xref:3.7@mule-management-console::creating-or-disbanding-a-cluster.adoc[Creating or Disbanding a Cluster].
...
* Learn about
xref:3.7@mule-management-console::deploying-redeploying-or-undeploying-an-application-to-or-from-a-cluster.adoc[deploying] and xref:3.7@mule-management-console::monitoring-a-cluster.adoc[monitoring] clusters.