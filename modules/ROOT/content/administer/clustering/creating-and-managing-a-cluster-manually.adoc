...
:page-aliases: creating-and-managing-a-cluster-manually.adoc
...
This page describes manual creation and configuration of a cluster. If you want to create and manage a cluster using the Management Console's graphical interface, see xref:3.8@mule-management-console::creating-or-disbanding-a-cluster.adoc[Creating or Disbanding a Cluster].
...
[TIP]
--
Check xref:install/hardware-and-software-requirements.adoc#mule-database-servers[Mule's hardware and software requirements] for a list of supported relational database management systems.

Keep in mind that, from that list, Oracle database support is a xref:release-notes::mule-runtime/3.8.0-release-notes.adoc#enterprise-edition-known-issues-and-limitations[known limitation] for Mule 3.8.x and it is planned for a future release.
--
...
This property can take three different values: `mssql`, `mysql` and `postgresql`^<<anchor-1,1>>^.
...
[CAUTION]
--
Oracle database support is a xref:release-notes::mule-runtime/3.8.0-release-notes.adoc#enterprise-edition-known-issues-and-limitations[known limitation] for Mule 3.8.x and it is planned for a future release.
--

== See Also

* Learn about
xref:3.8@mule-management-console::deploying-redeploying-or-undeploying-an-application-to-or-from-a-cluster.adoc[deploying] and xref:3.8@mule-management-console::monitoring-a-cluster.adoc[monitoring] clusters.