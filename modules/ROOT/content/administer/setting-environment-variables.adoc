...
:page-aliases: setting-environment-variables.adoc
...
+
image::administer/run-configurations-1.png[run+configurations+1]
...
+
image::administer/run-configurations-4.png[run+configurations+4]

. Then pick the *Environment* tab, and add the variables you need by clicking the *New* button.
+
image::administer/run-configurations-2.png[run+configurations+2]
...
* Learn more about xref:shared-resources/domain-project-shared-resources.adoc[Shared Resources]
