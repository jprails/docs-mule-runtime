...
spend much time explaining components. More detailed explanations and concepts exist in the xref:general:getting-started:index.adoc[Anypoint Fundamentals].
...
This tutorial assumes that you have xref:5@studio::download-and-launch-anypoint-studio.adoc[downloaded, installed, and launched Anypoint Studio], and that you've read through the xref:5@studio::index.adoc[Anypoint Studio Essentials].
