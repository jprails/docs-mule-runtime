...
* xref:mel/mule-expression-language-mel.adoc[Mule Expression Language] - Mule has a powerful expression language built-in for querying request and response payloads and headers. We'll use an expression to log something useful with the logger component.
...
* Next: xref:filtering-invalid-requests.adoc[Filtering Invalid Requests]
