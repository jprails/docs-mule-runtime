...
[NOTE]
This feature is supported by the Mule runtime as of xref:release-notes::mule-runtime/3.7.0-release-notes.adoc[Mule  3.7.0] in both Community and Enterprise editions. However, Studio support only became available starting with the September 2015 release.
...
[TIP]
If none of the validators described below cover what you need, you can also xref:validators/building-a-custom-validator.adoc[build a custom validator].
...
image::validators/validator-bustomize.png[validator]
...
* Read about xref:filters/filters.adoc[Filters] in Mule