...
* See how to configure the xref:3.8@connectors::http-connector.adoc[HTTP Connector]
* See how to handle a xref:3.8@connectors::tls-configuration.adoc#global-tls-configuration[Global TLS Configuration]