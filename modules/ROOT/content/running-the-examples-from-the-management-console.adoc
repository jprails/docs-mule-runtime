...
Consult the xref:3.6@install/installing.adoc[Installing] for details on launching Mule ESB Standalone with Management Console.
====
...
image::hello-example-folder.png[]
...
Next: xref:basic-studio-tutorial.adoc[Basic Studio Tutorial]

Previous: xref:understanding-mule-interaction-with-exchange-patterns.adoc[Understanding Mule Interaction with Exchange Patterns]