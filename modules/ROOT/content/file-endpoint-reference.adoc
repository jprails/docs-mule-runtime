...
See the xref:3.4@transports/file-transport-reference.adoc[File Transport Reference] for details on setting the properties for a File endpoint using an XML editor.