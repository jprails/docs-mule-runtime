...
The `<reply-to>` endpoint can be any valid xref:endpoints/mule-endpoint-uris.adoc[Mule endpoint URI]. For information on which transports support reply-to, see xref:transports/transports-reference.adoc[Transports Reference].
