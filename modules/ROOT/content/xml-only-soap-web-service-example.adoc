...
* Learn more about the xref:components/cxf-component-reference.adoc[CXF component].
* Learn more about xref:6@studio::datamapper/datamapper-user-guide-and-reference.adoc[DataMapper].
* Examine other xref:mule-examples.adoc[Mule application examples], particularly the xref:foreach-processing-and-choice-routing-example.adoc[Foreach Processing and Choice Routing Example] which also demonstrates content-based routing in Web service integrations.