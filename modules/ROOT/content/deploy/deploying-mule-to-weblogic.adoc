...
. _Required_. Override commons-lang as described in xref:deploy/deploying-mule-to-weblogic.adoc[Overriding commons-lang]
. Configure logging as described in xref:deploy/deploying-mule-to-weblogic.adoc[Configuring Logging].
