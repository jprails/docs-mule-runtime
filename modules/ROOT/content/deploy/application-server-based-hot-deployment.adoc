...
:page-aliases: application-server-based-hot-deployment.adoc
...
To deploy Mule as a service to Tomcat or Tcat Server, see xref:3.6@deploy/deploying-mule-as-a-service-to-tomcat.adoc[Deploying Mule as a Service to Tomcat].
