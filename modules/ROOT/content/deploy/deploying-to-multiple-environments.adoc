...
This document assumes that you are familiar with the exercise of building and deploying Mule applications in Mule Studio. Consider reading the xref:3.7@mule-fundamentals.adoc[Mule Fundamentals] and xref:general:getting-started:index.adoc[Anypoint Fundamentals] for more information.
...
[TIP]
====
Learn how to encrypt a properties file using the xref:3.6@security/mule-credentials-vault.adoc[Mule Credentials Vault].
====
...
* Learn more about encrypting a properties file using the xref:3.6@security/mule-credentials-vault.adoc[Mule Credentials Vault].
