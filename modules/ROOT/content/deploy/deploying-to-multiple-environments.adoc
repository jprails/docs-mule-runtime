...
+
image::deploy/deploying-to-multiple-environments-09f16.png[]
...
+
image::deploy/deploying-to-multiple-environments-213ae.png[]
+
[TIP]
====
...
. To configure Studio to use a specific environment when  *deploying on-premise* , *debugging*  or  *using xref:6@studio::datasense/datasense.adoc[DataSense]*  to retrieve metadata from a SaaS provider, double-click to open your application's  `mule-project.xml` file, located in the root directory of your project.
+
[WARNING]
====
...
+
image::deploy/deploying-to-multiple-environments-83bcc.png[]
...
+
image::deploy/deploying-to-multiple-environments-88886.png[]
