...
:page-aliases: hardening-your-mule-installation.adoc
...
On https://github.com/vagoff/xinx[Xnix], you can run Mule as any user with the following caveats:
...
Commercial configuration management and integrity management tools can help you automate management to the CIS benchmarks. Also, Mule documentation includes a good deal of information on xref:security/configuring-security.adoc[configuring security]. If your application deals in sensitive data, consider using SSL Transport (HTTPS) to protect it.
...
* http://openxource.com/xircles/portal.html[Xircles Community Portal]