...
For a list of the action codes available with each notification type, see the Javadocs for the https://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/context/notification/package-summary.html[org.mule.context.notification] package and click on the class of the notification type you want.
