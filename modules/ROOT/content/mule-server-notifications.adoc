...
For a list of notification types, see xref:mule-configuration/notifications-configuration-reference.adoc[Notifications Configuration Reference]. For a list of notification listener interfaces, see Notification Interfaces below.
...
For a list of the action codes available with each notification type, see the Javadocs for the https://www.mulesoft.org/docs/site/current/apidocs/org/mule/context/notification/package-summary.html[org.mule.context.notification] package and click on the class of the notification type you want.
