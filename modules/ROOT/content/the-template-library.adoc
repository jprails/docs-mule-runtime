...
[%autowidth.spread]
|===
|*https://blogs.mulesoft.com/dev/mule-dev/data-integration-patterns-migration/[Migration]* |*https://blogs.mulesoft.com/dev/mule-dev/data-integration-patterns-broadcast/[Broadcast]* |*https://blogs.mulesoft.com/dev/mule-dev/data-integration-patterns-bi-directional-sync/[Bi-Directional Sync]* |*https://blogs.mulesoft.com/dev/mule-dev/data-integration-patterns-aggregation/[Aggregation]* |*https://blogs.mulesoft.com/dev/mule-dev/data-integration-patterns-correlation/[Correlation]*
...
. Now your app is now ready to xref:general:getting-started:index.adoc[Deploy]

== Go Further

* Learn the different ways you can xref:general:getting-started:index.adoc[Deploy] your app
* Implement the xref:3.5@mule-management-console::index.adoc[Mule Management Console] in your deployment
