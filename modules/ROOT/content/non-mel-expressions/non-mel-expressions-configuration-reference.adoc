...
https://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/api/expression/ExpressionManager.html[ExpressionEvaluatorManager]
...
https://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/module/json/JsonExpressionEvaluator.html[JsonExpressionEvaluator]
...
https://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/api/MuleMessage.html[MuleMessage]
