...
[TIP]
The new *Mule Expression Language (MEL)* obviates the need to use old expressions in Mule. Refer to xref:mel/mule-expression-language-mel.adoc[Mule Expression Language MEL] for details on how to use MEL.
