...
:page-aliases: mule-fundamentals.adoc, mule-concepts.adoc
...
image::concepts/flow1-1.png[Flow1-1]
...
image::concepts/simple-flow2.png[simple+flow2]
...
[source,xml,linenums]
----
include::{samplesdir}/mule-concepts.xml[]
----
=====
...
Within many of the fields of the message processors of your flow, you can use xref:mel/mule-expression-language-mel.adoc[Mule Expression Language] to extract information about the message or its environment and instruct Mule to make processing decisions based on that information.
...
image::concepts/batch-main1.png[batch_main1]
...
* *NEXT STEP:* Learn more about the xref:flows/elements-in-a-mule-flow.adoc[elements in a Mule flow].
* Find out more about xref:batch/batch-processing.adoc[Batch Processing]. +