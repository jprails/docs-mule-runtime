...
The legacy endpoint-based connector will be removed in a future version. See xref:3.6@connectors::http-connector.adoc[HTTP Connector] for more information about the HTTP operation-based connector and how to xref:3.6@connectors::migrating-to-the-new-http-connector.adoc[migrate] your projects to it.
====
...
|Doc |https://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/transport/http/package-summary.html[JavaDoc], http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_http/namespace-overview.html[SchemaDoc]
...
|Maven Artifact |org.mule.transport:mule-transport-http |The group name a artifact name for this transport in http://maven.apache.org/[Maven]
|===
...
The HTTP transport supports polling an HTTP URL, which is useful for grabbing periodic data from a page that changes or to invoke a REST service, such as polling an https://aws.amazon.com/sqs/[Amazon Queue].
...
[TIP]
See the HTTP protocol specification for detailed information on  http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html[HTTP Status Codes].
