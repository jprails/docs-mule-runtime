...
:page-aliases: debugging-outside-studio.adoc
:keywords: debugging, debug

In Anypoint Studio, you can use the xref:5@studio::studio-visual-debugger.adoc[Studio Visual Debugger] to help you troubleshoot your app. If you're creating your Mule app outside Studio, you can resort to the following options:
