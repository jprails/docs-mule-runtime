...
* A *xref:transports/connecting-using-transports.adoc[transport]* is a type of module that carries messages between Mule services via a specific protocol. For a list of the available transports you can use, see xref:transports/transports-reference.adoc[Transports Reference].
