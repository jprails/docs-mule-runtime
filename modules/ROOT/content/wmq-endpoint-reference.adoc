...
|===
|image:information.png[] |Required fields for this endpoint are listed in *bold*.
...
See the xref:transports/mule-wmq-transport-reference.adoc[Mule WMQ Transport Reference] for details on setting the properties for a WMQ endpoint using an XML editor.