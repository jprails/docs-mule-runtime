...
See the xref:3.4@transports/mule-wmq-transport-reference.adoc[Mule WMQ Transport Reference] for details on setting the properties for a WMQ endpoint using an XML editor.