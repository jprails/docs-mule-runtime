...
* Learn how to xref:mule-and-maven.adoc[build new Maven projects] directly in Studio
* Learn how to xref:converting-studio-into-maven.adoc["mavenize" existing Studio projects].
