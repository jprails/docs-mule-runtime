...
+
image::mule-configuration/extra-cxf-component-configurations-823fb.png[]
+
The *Choose Global Type* dialog appears.
+
. Select *Component configurations* > *CXF Configuration*.
+
image::mule-configuration/extra-cxf-component-configurations-824d9.png[]
+
. Click OK.
+
The CXF Configuration dialog appears.
+
image::mule-configuration/extra-cxf-component-configurations-32070.png[]
+
...
. Open the properties editor, and on the *Interceptors* tab, click the image:mule-configuration/add.png[(plus)] drop-down.
+
The *http://cxf.apache.org/docs/interceptors.html[Interceptor Provider]* options appear:
+
image::mule-configuration/extra-cxf-component-configurations-fbe86.png[]
+
. Select one of the options, for example *Add in interceptor*.
+
The selected interceptor option appears in *Settings*.
+
image::mule-configuration/extra-cxf-component-configurations-628c3.png[]
...
+
image::mule-configuration/extra-cxf-component-configurations-6f0a1.png[]
...
image::mule-configuration/extra-cxf-component-configurations-7d94a.png[]

The *Schema Locations* configuration is available only for the Proxy service operation.

image::mule-configuration/extra-cxf-component-configurations-402ba.png[]
...
|http://msdn.microsoft.com/en-us/library/ms256100.aspx[*Schema Locations*] |Click image:mule-configuration/add.png[] in *Schema Locations* to specify a `schemaLocations` attribute that identifies a namespace `name` and `description`.
|===
