...
:page-aliases: extra-cxf-component-configurations.adoc

This page covers more complex configuration of the CXF Component than those described in the basic discussions of xref:3.6@api-usage/publishing-a-soap-api.adoc[publishing a SOAP API] and xref:3.7@api-usage/consuming-a-soap-api.adoc[consuming a SOAP API]. You may also wish to refer to full xref:3.6@components/cxf-component-reference.adoc[CXF Component Reference] documentation.
...
+
[NOTE]
You can also create a *Global CXF Element* directly from the CXF component's properties editor. Next to the *Config Reference* field, click the image:mule-configuration/add.png[(plus)] icon to open the *Global Element Properties* panel.
+
image::mule-configuration/global.png[]

. Configure the global CXF configuration attributes according to the table below.
+
image::mule-configuration/global-properties.png[global_properties]
+
...
+
image::mule-configuration/select-global.png[select_global]
...
. Click on the image:mule-configuration/add.png[(plus)] icon to reveal the four  *http://cxf.apache.org/docs/interceptors.html[Interceptor Providers]* CXF uses to add interceptors to interceptor chains; click one of the choices to add an interceptor provider.
...
+
image::mule-configuration/studio-interceptorssettings.png[Studio-interceptorssettings]
...
+
image::mule-configuration/cxf-adv.png[CXF-adv]
...
|*Schema Locations* |Click the image:mule-configuration/add.png[] icon in the *Schema Locations* pane to specify a `schemaLocations` attribute that identifies a namespace `name` and `description`. Reference http://msdn.microsoft.com/en-us/library/ms256100.aspx[schemaLocation] for additional details.
|===
...
* Access full xref:3.6@components/cxf-component-reference.adoc[CXF Component Reference] documentation.

* Learn the basics of xref:3.6@api-usage/publishing-a-soap-api.adoc[publishing a SOAP API].

* Learn the basics of xref:3.7@api-usage/consuming-a-soap-api.adoc[consuming a SOAP API].