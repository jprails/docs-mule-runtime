...
:page-aliases: improving-performance-with-the-kryo-serializer.adoc
...
image::mule-configuration/persistentvmqueues.png[PersistentVMQueues]

image::mule-configuration/persistentobjectstores.png[PersistentObjectStores]

image::mule-configuration/ha-vmserializationtps.png[HA_VMSerializationTPS]

image::mule-configuration/ha-persistentobjectstoretps.png[HA_PersistentObjectStoreTPS]
