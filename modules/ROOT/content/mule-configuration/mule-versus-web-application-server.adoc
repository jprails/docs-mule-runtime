...
* xref:5@studio::index.adoc[Download, then install and launch Anypoint Studio].
* Investigate different xref:3.7@deploy/deployment-scenarios.adoc[Deployment Scenarios].
