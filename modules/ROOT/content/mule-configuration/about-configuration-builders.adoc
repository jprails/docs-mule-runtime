...
This configuration builder allows a JSR-223 complaint script engine such as Groovy or Jython to configure Mule. For more information, see xref:modules/scripting-module-reference.adoc[Scripting Module Reference].
