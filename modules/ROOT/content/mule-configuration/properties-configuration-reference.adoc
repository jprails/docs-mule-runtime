...
:page-aliases: properties-configuration-reference.adoc
...
A global property is a named string. It can be inserted in most attribute values using standard (http://ant.apache.org/[Apache Ant]-style) Spring placeholders.
