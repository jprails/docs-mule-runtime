...
This page provides details on the global settings you configure at the root level of a Mule configuration. For more information on configuration, see xref:3.7@mule-configuration/about-mule-configuration.adoc[About Mule Configuration]. For information on threading profiles, see xref:3.6@administer/tuning-performance.adoc[Tuning Performance].
