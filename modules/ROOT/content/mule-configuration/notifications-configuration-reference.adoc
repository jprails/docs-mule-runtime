...
:page-aliases: notifications-configuration-reference.adoc
:keywords: anypoint studio, esb, notifications, error messages, responses, exceptions, monitor

This page provides details on the elements you configure for notifications. If the information appears to be out of date, refresh the page. For more information on notifications, see xref:3.7@mule-server-notifications.adoc[Mule Server Notifications].
