...
Other namespaces can be introduced via `<spring:beans>` or by adding a dedicated element in a module (see the xref:3.6@modules/scripting-module-reference.adoc[Scripting module's] `<lang>` element).
