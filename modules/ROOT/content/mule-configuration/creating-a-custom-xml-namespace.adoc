...
:page-aliases: creating-a-custom-xml-namespace.adoc
...
Other namespaces can be introduced via `<spring:beans>` or by adding a dedicated element in a module (see the xref:modules/scripting-module-reference.adoc[Scripting module's] `<lang>` element).
...
* A couple of blog posts (https://decaresystemsblog.wordpress.com/2006/03/29/spring-20-hiding-services-behind-custom-schema-part-i/[1], https://decaresystemsblog.wordpress.com/2006/04/04/spring-20-hiding-services-behind-custom-xml-schema-part-ii/[2]) that give a developer's-eye overview.
