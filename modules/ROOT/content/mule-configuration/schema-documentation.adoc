...
If you are familiar with previous versions of Mule, you may want to consult this list of xref:mule-configuration/notes-on-mule-3.0-schema-changes.adoc[schema changes].
