...
:page-aliases: schema-documentation.adoc
...
If you are familiar with versions of Mule older than v 3.0, you may want to consult this list of xref:3.6@mule-configuration/notes-on-mule-3.0-schema-changes.adoc[schema changes].
...
* https://www.mulesoft.org/docs/site/3.5.0/apidocs/[API Docs]
* http://www.mulesoft.org/docs/site/3.5.0/testapidocs/[Test API Docs]
