...
:page-aliases: connecting-with-transports-and-connectors.adoc
...
How to use each connector depends on the specific connector. You can find a list of available connectors in https://www.mulesoft.com/exchange[Anypoint Exchange].

=== Developing a Connector

Developing a connector is as straightforward as using them. See xref:3.3@connector-devkit::devkit-overview.adoc[Anypoint Connector DevKit].
