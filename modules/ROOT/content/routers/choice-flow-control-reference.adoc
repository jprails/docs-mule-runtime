...
In Studio, drag the *Choice* icon from the Studio palette to the canvas, positioning it within the sequence of xref:studio-building-blocks.adoc[building blocks] that form the flow (below).

image::routers/studio-choice-add.png[Studio_Choice_add]
...
+
image::routers/studio-choice-routingoptions.png[Studio_Choice_routingoptions]
+
...
+
image::routers/studio-choice-add1.png[Studio_Choice_add1]
+
...
+
image::routers/studio-choice-add2.png[Studio_Choice_Add2]
...
+
image::routers/studio-choice-add3.png[Studio_Choice_Add3]
...
+
image::routers/studio-choice-add4.png[Studio_Choice_add4]
====

[start="2"]
. Double-click to open the Choice Flow Control's *Pattern Properties* panel (below).
+
image::routers/studio-choice-patternproperties.png[Studio_Choice_PatternProperties]
...
+
image::routers/studio-choice-routeproperties-expression.png[Studio_Choice_RouteProperties_Expression]
...
+
image::routers/studio-choice-patternproperties-configured1.png[Studio_Choice_PatternProperties_configured1]
...
+
image::routers/studio-choice-default-routeproperties.png[Studio_Choice_default_routeproperties]
+
...
+
image::routers/studio-choice-newdefault1.png[Studio_Choice_newdefault1]

. Check the *Otherwise* box (see below), then click *OK*.
+
image::routers/choice4.png[]
...
+
image::routers/studio-choice-newdefault3.png[Studio_Choice_newdefault3]
...
+
image::routers/studio-choice-neworder.png[Studio_Choice_NewOrder]
