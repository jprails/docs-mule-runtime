...
In Studio, drag the *Choice* icon from the Studio palette to the canvas, positioning it within the sequence of xref:flows/elements-in-a-mule-flow.adoc[processors] that form the flow (below).

image::routers/choice-summary-flow.png[]
...
+
image::routers/choice-props-set-new-default.png[]
+
...
+
image::routers/choice-spanish-set-as-new-default.png[]
+
