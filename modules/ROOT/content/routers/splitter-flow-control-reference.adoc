...
image::routers/studio-splitter.png[Studio_splitter]
...
+
image::routers/studio-splitterflow0.png[Studio-splitterflow0]
...
+
image::routers/studio-splitterflow1.png[Studio-splitterflow1]
...
+
image::routers/studio-splitterflow.png[Studio-splitterflow]
...
You can look at the values of these outbound variables by putting a break point after the splitter and running your flow with the xref:5@studio::studio-visual-debugger.adoc[Studio Visual Debugger]:
...
* Learn more about xref:3.7@mel/mule-expression-language-mel.adoc[Mule Expression Language (MEL)]
* Learn about other xref:3.6@routers/all-flow-control-reference.adoc[Flow Control] elements
* Read more about the xref:3.6@scopes/async-scope-reference.adoc[Async Scope]