...
This document assumes you are familiar with Mule applications and xref:3.4@message-processors.adoc[message processors], in particular xref:routers/routers.adoc[routing message processors].
...
timeout="6000"
----
|*Threading Profile* |Optionally, use to customize the threading profile. Refer to xref:3.6@administer/tuning-performance.adoc[Tuning Performance] for a description of the configurable attributes. For a brief discussion of threading profiles in Scatter-Gather, see the section below. + |Default threading profile a|
[source,xml,linenums]
----
...
|===
|Optional Child Element |Description
|*threading-profile* |Allows you to configure the underlying thread pool. Refer to xref:3.6@administer/tuning-performance.adoc[Tuning Performance] for a list of configurable attributes, all of which can be applied here. For a brief discussion of threading profiles in Scatter-Gather, see the section below.
|===
...
For details on setting up threading profiles, see xref:3.6@administer/tuning-performance.adoc[Tuning Performance].
