...
image::routers/studio-scattergather.png[]


[discrete]
==== General Tab

image::routers/scatterconf.png[]
...
image::routers/sg-adv-tab.png[sg-adv_tab]
...
|*Threading Profile* |Optionally, use to customize the threading profile. Refer to xref:administer/tuning-performance.adoc[Tuning Performance] for a description of the configurable attributes. For a brief discussion of threading profiles in Scatter-Gather, see the section below. + |Default threading profile a|
|===
...
image::routers/scatter-gather2d.png[scatter_gather2d]
...
image::routers/sg-adv-tab2.png[sg-adv_tab2]
