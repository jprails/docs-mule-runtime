...
Access the documentation for the xref:3.7@routers/scatter-gather.adoc[Scatter-Gather flow control] to take advantage of the newly-designed functionality.
====
