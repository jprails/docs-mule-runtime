...
:page-aliases: creating-custom-routers.adoc

Typically, you implement custom routing in Mule ESB with xref:using-filters.adoc[filters], but occasionally you may need to implement a custom router.
...
The easiest way to write an outbound router is to extend the https://www.mulesoft.org/docs/site/current/apidocs/org/mule/routing/outbound/AbstractOutboundRouter.html[org.mule.routing.outbound.AbstractOutboundRouter] class:
