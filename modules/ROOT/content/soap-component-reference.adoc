...
Using Mule's SOAP Component, you can also xref:3.6@modules/enabling-ws-security.adoc[enable WS-security], specify data bindings, and add interceptors to your CXF Web service. For more information about how Mule leverages the CXF framework, consult the xref:3.6@modules/cxf-module-configuration-reference.adoc[CXF Module Configuration Reference].
...
Consult the xref:3.6@modules/enabling-ws-security.adoc[Enabling WS-Security] document to configure the security elements of your Web service.
...
* xref:3.6@modules/cxf-module-reference.adoc[CXF Module]
* xref:3.6@modules/enabling-ws-security.adoc[security]