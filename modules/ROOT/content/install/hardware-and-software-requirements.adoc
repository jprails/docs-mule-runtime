...
a|
* xref:3.6@mule-management-console::persisting-mmc-data-to-oracle.adoc[Oracle]
* xref:3.6@mule-management-console::persisting-mmc-data-to-postgresql.adoc[Postgres ]
* xref:3.6@mule-management-console::persisting-mmc-data-to-mysql.adoc[MySQL]
* xref:3.6@mule-management-console::persisting-mmc-data-to-ms-sql-server.adoc[MS SQL Server]
|===
