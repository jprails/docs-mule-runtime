...
:page-aliases: hardware-and-software-requirements.adoc
...
* xref:3.5@mule-management-console::persisting-mmc-data-to-oracle.adoc[Oracle]
* xref:3.5@mule-management-console::persisting-mmc-data-to-postgresql.adoc[Postgres ]
* xref:3.5@mule-management-console::persisting-mmc-data-to-mysql.adoc[MySQL]
* xref:3.5@mule-management-console::persisting-mmc-data-to-ms-sql-server.adoc[MS SQL Server]
...
Get more information about installing xref:5@studio::studio-in-eclipse.adoc[Studio as an Eclipse plug-in].
...
* Learn how to xref:install/downloading-and-starting-mule-esb.adoc[download and Start Mule ESB].
* Learn more about installing an xref:install/installing-an-enterprise-license.adoc[Enterprise license].
