...
:page-aliases: downloading-and-starting-mule-esb.adoc
...
xref:install/hardware-and-software-requirements.adoc[Hardware and Software Requirements] for reference. See also <<runningstudioonamac,Running Studio on a Mac>>.
+
image::install/anypoint-studio.png[anypoint_Studio]
+
...
+
image::install/finder.png[]
+
. Click OK to accept the default workspace.
+
image::install/launcher.png[]
+
. Studio launches, then displays a Welcome page. Click *Create a Project* to begin development immediately.
. Optional: xref:5@studio::mule-runtime/adding-community-runtime.adoc[Add the Community Runtime]
to your Studio instance.
. Optional: xref:install/installing-an-enterprise-license.adoc[Installing an Enterprise License] (recommended for running applications in production).
...
xref:install/hardware-and-software-requirements.adoc[Hardware and Software Requirements] for reference.
. Set your `JAVA_HOME` environment variable to the path in which you installed the JDK.
...
+
image::install/mmc-welcome-screen.png[mmc_welcome_screen]
+
[NOTE]
...
* xref:security/installing-anypoint-enterprise-security.adoc[Anypoint Enterprise Security]
* xref:3.5@connectors::index.adoc[Anypoint Connectors]
* mailto:sales@mulesoft.com[Contact MuleSoft] to acquire entitlements to access the https://mulesoft.github.io/sap-transport/[SAP Connector] and/or xref:administer/clustering/mule-high-availability-ha-clusters.adoc[High Availability Clustering]

== See Also

* Learn more about acquiring and installing an xref:install/installing-an-enterprise-license.adoc[Installing an Enterprise License].
...
* Learn more about the xref:3.5@mule-management-console::index.adoc[Mule Management Console].
* xref:5@studio::installing-extensions.adoc[Extend Mule] with plugins, modules, runtimes and connectors.
* Access a list of all the xref:5@studio::install-update-items-in-studio.adoc[update sites] available for your version of Studio.
