...
. _Optional_: xref:6@studio::mule-runtime/adding-community-runtime.adoc[Add Mule CE] to your Studio instance.
...
* Learn more about xref:install/installing-an-enterprise-license.adoc[Installing an Enterprise License].
* Learn about xref:deploy/configuring-mule-as-a-windows-service.adoc[Configuring Mule as a Windows Service].
* Read http://blogs.mulesoft.com/?s=one+studio[One Studio] that explains the Single Studio distribution.
* Get started learning xref:concepts/index.adoc[Key Concepts].
* Learn more about the xref:3.8@mule-management-console::index.adoc[Mule Management Console].
* xref:6@studio::install-update-items-in-studio.adoc[Extend Mule] with plugins, modules, runtimes, and connectors.
* Access a list of all the xref:6@studio::install-update-items-in-studio.adoc[update sites] available for your version of Studio.