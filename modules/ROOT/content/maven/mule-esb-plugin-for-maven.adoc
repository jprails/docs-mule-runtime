...
[NOTE]
For the above example to work, you need to have the Mule ESB repository defined in your `settings.xml` or your `pom.xml`. For details, see xref:maven/using-maven-with-mule.adoc[Using Maven with Mule] and xref:maven/configuring-maven-to-work-with-mule-esb.adoc[Configuring Maven to Work with Mule].
...
* For more information about developing Mule applications with Maven, see the overview in xref:maven/using-maven-with-mule.adoc[Using Maven with Mule] and xref:5@studio::maven/building-a-mule-application-with-maven-in-studio.adoc[Building a Mule Application with Maven in Studio].
...
* Access additional Maven xref:maven/maven-reference.adoc[reference] and /mule-user-guide/v/3.6/configuring-maven-to-work-with-mule-esb[configuration] information.