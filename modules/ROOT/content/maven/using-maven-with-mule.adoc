...
[TIP]
For info on how to use Maven in the context of Anypoint Sutio, MuleSoft's IDE for developing integration applications, see xref:5@studio::maven/using-maven-in-anypoint-studio.adoc[Use Maven in Anypoint Studio]
