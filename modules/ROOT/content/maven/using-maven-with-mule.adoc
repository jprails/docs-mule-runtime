...
* xref:6@studio::maven/building-a-mule-application-with-maven-in-studio.adoc[Building a Mule application with Maven in Studio]
* xref:6@studio::maven/enabling-maven-support-for-a-studio-project.adoc[Enabling Maven support for an existing Studio project]
* xref:6@studio::maven/importing-a-maven-project-into-studio.adoc[Importing a Maven project into Studio]

*In Mule:*

Maven-Mule functionality is provided by two Mule plugins for Maven.

* xref:maven/maven-tools-for-mule-esb.adoc[Maven tools for Mule] is a plugin that provides archetypes for building regular Mule applications, allowing you to develop Mule applications from within Maven
* The xref:maven/mule-maven-plugin.adoc[Mule Maven plugin] allows you to control Mule instances from within a Maven environment
...
* xref:6@studio::maven/using-maven-in-anypoint-studio.adoc[Using Maven in Anypoint Studio]
** xref:6@studio::maven/maven-support-in-anypoint-studio.adoc[Maven Support in Anypoint Studio]
** xref:6@studio::maven/building-a-mule-application-with-maven-in-studio.adoc[Building a Mule Application with Maven in Studio]
** xref:6@studio::maven/enabling-maven-support-for-a-studio-project.adoc[Enabling Maven Support for a Studio Project]
** xref:6@studio::maven/importing-a-maven-project-into-studio.adoc[Importing a Maven Project into Studio]
* xref:maven/using-maven-in-mule-esb.adoc[Using Maven in Mule Runtime]
...
* Learn more about xref:6@studio::maven/maven-support-in-anypoint-studio.adoc[adjusting your Studio Preferences to work with Maven].
* Learn more about xref:6@studio::maven/importing-a-maven-project-into-studio.adoc[importing Maven projects into Studio] or xref:6@studio::maven/enabling-maven-support-for-a-studio-project.adoc["mavenizing" existing Studio projects].
* Using Maven outside of Studio? Refer to these instructions for xref:maven/configuring-maven-to-work-with-mule-esb.adoc[configuring your Maven installation] to point to the necessary repositories.
* Access the xref:maven/maven-reference.adoc[Maven reference documentation].