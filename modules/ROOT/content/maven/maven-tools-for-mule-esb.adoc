...
* Learn how to use the xref:maven/mule-esb-plugin-for-maven.adoc[Mule ESB plugin for Maven] to control Mule ESB instances from a Maven environment
...
* Access additional Maven xref:maven/maven-reference.adoc[Maven Reference] and xref:maven/configuring-maven-to-work-with-mule-esb.adoc[Configuring Maven to Work with Mule ESB] information.