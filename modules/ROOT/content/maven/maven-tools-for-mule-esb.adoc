...
:page-aliases: maven-tools-for-mule-esb.adoc
...
* For more information about developing Mule applications with Maven, see the overview in xref:maven/using-maven-with-mule.adoc[Using Maven with Mule], and the guides at xref:6@studio::maven/building-a-mule-application-with-maven-in-studio.adoc[Building a Mule Application with Maven in Studio] and xref:maven/using-maven-in-mule-esb.adoc[Using Maven in Mule].
* Learn how to use the xref:maven/mule-esb-plugin-for-maven.adoc[Mule Plugin for Maven] to control Mule instances from a Maven environment
...
* Access additional Maven xref:maven/maven-reference.adoc[Maven Reference] and xref:maven/configuring-maven-to-work-with-mule-esb.adoc[Configuring Maven to Work with Mule] information.