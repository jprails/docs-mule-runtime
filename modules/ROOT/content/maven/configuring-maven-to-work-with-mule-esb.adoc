...
Developing in Maven is greatly simplified by the xref:maven/maven-tools-for-mule-esb.adoc[Maven Tools for Mule ESB] plugin, which provides Maven archetypes for building Mule applications.

== Assumptions

This document assumes that you are working with Maven outside of Anypoint Studio, and thus will be using archetypes to build Mule applications. See xref:maven/using-maven-with-mule.adoc[Using Maven with Mule] for an overview of using Maven to manage your Mule projects.
