...
|✓
|Medium
|xref:apikit::index.adoc[REST API with APIkit]
...
|✓
|Low
|xref:3.3@gps-walker-example.adoc[gpswalker]
...
|✓
|Low
|xref:3.3@scripting-example.adoc[scripting]
...
|✓
|Medium
|xref:3.3@foreach-example.adoc[foreach]
|image:iteration2.png[]Processes collections iteratively without losing any of the payload.
|✓
|✓
|Medium
|xref:3.3@bookstore-example.adoc[bookstore]
|image:icon-world-blue-big.png[]Exposes a Web service using Jetty and CXF. +
|✓
|✓
|Medium
|xref:3.3@stock-quote-example.adoc[stockquote]
...
|✓
|High
|xref:3.3@flight-reservation-example.adoc[flight-reservation]
|image:iteration2.png[]Processes collections iteratively without losing any of the payload. +
 +
image:orchestrate.png[]Orchestrates a sequence of calls to other services or message queues.
|✓
|✓
|High
|xref:3.3@jdbc-transport-example.adoc[jdbc]
...
xref:5@studio::mule-runtime/adding-community-runtime.adoc[How do I get Mule Community runtime?] +
 +
