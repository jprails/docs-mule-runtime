...
:page-aliases: sap-jco-extended-properties.adoc
...
|jco.client.snc_mode |Secure network connection (SNC) mode, 0 image:sap-jco/lightbulb.png[(grey lightbulb)] or 1 image:sap-jco/lightbulb-on.png[(lightbulb on)] | |
