...
It has always been possible to connect Mule to these services in the past using specific xref:transports/transports-reference.adoc[transports]. Mule Cloud Connect creates a layer on top of these services to simplify the use of these services even further.
