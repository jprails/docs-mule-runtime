...
Skip ahead to the xref:xml-only-soap-web-service-example.adoc[XML-only SOAP Web Service Example] if you prefer to simply examine this example via screenshots and code snippets.
...
* Learn more about about the xref:3.5@connectors::web-service-consumer.adoc[Web Service Consumer].
* Learn more about the xref:components/http-response-builder.adoc[HTTP Response Builder].
* See xref:6@studio::datamapper/datamapper-user-guide-and-reference.adoc[Anypoint DataMapper User Guide and Reference].
