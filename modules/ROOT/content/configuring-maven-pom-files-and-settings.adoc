...
* Read more about xref:maven/using-maven-with-mule.adoc[Using Maven with Mule].
* Follow along with this xref:5@studio::maven/building-a-mule-application-with-maven-in-studio.adoc[Building a Mule Application with Maven in Studio] that demonstrates the end-to-end experience of using Maven to create, manage, and deploy a Mule project.
* Learn more about xref:apikit::creating-an-apikit-project-with-maven.adoc[Creating an APIkit project with Maven].