...
https://www.mulesoft.org/docs/site/current/apidocs/org/mule/module/acegi/filters/http/HttpBasicAuthenticationFilter.html[HttpBasicAuthenticationFilter]
...
For more information see xref:3.7@security/configuring-security.adoc[Configuring Security].
