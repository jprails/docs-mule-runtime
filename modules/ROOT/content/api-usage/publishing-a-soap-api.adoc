...
:page-aliases: publishing-a-soap-api.adoc
:keywords: cxf

[NOTE]
When sending requests to an external web service, the recommended approach is to use the xref:3.6@connectors::web-service-consumer.adoc[Web Service Consumer]﻿ rather than the CXF Module.
...
Using Mule's CXF Component, you can also xref:api-usage/securing-a-soap-api.adoc[enable WS-security], specify databindings, and add interceptors to your CXF API. For more information about how Mule leverages the CXF framework, consult the xref:modules/cxf-module-reference.adoc[CXF Module Configuration Reference].



== Assumptions

This document describes the details of the example within the context of Anypoint Studio, Mule ESB’s graphical user interface (GUI). Where appropriate, the XML configuration accompanies the Studio interface screenshots. This document assumes that you are familiar with Mule ESB and the xref:6@studio::index.adoc[Anypoint Studio interface].
...
image::api-usage/soap-flow1.png[SOAP-flow1]
...
Through CXF, Mule allows you to present this WSDL contract using one of two http://en.wikipedia.org/wiki/Web_service#Automated_design_methods[methods]:
...
image::api-usage/cxf-1.png[CXF-1]

image::api-usage/cxf-2.png[CXF-2]
...
+
image::api-usage/basic-flow.png[basic+flow]
+
+
+
...
+
image::api-usage/cxf-3.png[CXF-3]
+
...
+
image::api-usage/cxfflow2.png[CXFflow2]
+
[%header%autowidth.spread]
|===
|Field |Value
...
+
image::api-usage/basic-flow2.png[basic+flow2]
+
...
+
image::api-usage/basic-flow3.png[basic+flow3]
+
...
+
image::api-usage/cxfex2.png[CXFex2]
+
[%header%autowidth.spread]
|===
|Field |Value
...
+
image::api-usage/orderapiadv.png[OrderAPIadv]
+
[%header%autowidth.spread]
|===
|Field |Value
...
. Configure the *CXF component* as per the image and table below. At runtime, the output of this component is a POJO.
+
image::api-usage/newcxforderapi.png[newCXForderapi]
+
...
image::api-usage/newcxforderapi-genfromwsdl.png[newCXForderapi-genfromwsdl]
...
Consult the xref:api-usage/securing-a-soap-api.adoc[Securing a SOAP API] document to configure the security elements of your API.

== See Also

* Consult the xref:components/cxf-component-reference.adoc[CXF Component Reference].
...
* Learn how to xref:api-manager::setting-up-an-api-proxy.adoc#anatomy-of-a-soap-proxy[proxy a SOAP API] with Mule.