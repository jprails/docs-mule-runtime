...
+
image::api-usage/soapflow1.png[SOAPflow1]
...
+
image::api-usage/cxfflow3.png[CXFflow3]
+
...
+
image::api-usage/orderapiflow.png[OrderAPIflow]
+
...
+
image::api-usage/soapflow1-1.png[SOAPflow1+(1)]
