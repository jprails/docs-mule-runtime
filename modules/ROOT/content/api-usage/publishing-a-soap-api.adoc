...
Using the Mule xref:modules/cxf-module-reference.adoc[CXF Component], you can also xref:api-usage/securing-a-soap-api.adoc[enable WS-security], specify data bindings, and add interceptors to your CXF API.

When sending requests to an external web service, using the xref:3.8@connectors::web-service-consumer.adoc[Web Service Consumer]﻿ instead of the CXF Module is recommended.
...
image::api-usage/publishing-a-soap-api-ecf2e.png[]
...
image::api-usage/publishing-a-soap-api-7a05b.png[]
...
image::api-usage/publishing-a-soap-api-15690.png[]
...
+
image::api-usage/publishing-a-soap-api-ed81d.png[]
+
+
+
...
+
image::api-usage/publishing-a-soap-api-3ea0e.png[]
+
...
+
image::api-usage/publishing-a-soap-api-5e239.png[]
+
[%header%autowidth.spread]
|===
|Field |Value
...
+
image::api-usage/publishing-a-soap-api-6105b.png[]
+
...
+
image::api-usage/publishing-a-soap-api-b58ec.png[]
+
...
+
image::api-usage/publishing-a-soap-api-df761.png[]
+
