...
:page-aliases: proxying-web-services.adoc
...
[TIP]
Instead of building a proxy application from scratch, consider using an xref:api-manager::proxy-about.adoc[Anypoint Platform Proxy].
...
http://www.mulesoft.org/schema/mule/core http://www.mulesoft.org/schema/mule/core/current/mule.xsd">
  <flow name="HttpProxyService">
      ...
      <http:outbound-endpoint host="www.webservicex.net#[header:INBOUND:http.request]" port="8888" path="#[message.inboundProperties.'http.listener.path']" method="#[message.inboundProperties.'http.method']" exchange-pattern="one-way" />
  </flow>
</mule>
----

This type of bridge can be combined with filters for easy message routing. For fast XPath routing of messages, you can use the xref:modules/sxc-module-reference.adoc[SXC Module Reference].
...
See the xref:3.6@modules/proxying-web-services-with-cxf.adoc[Proxying Web Services with CXF] for more details.