...
For a detailed description of the format used in this document, consult xref:3.6@mule-management-console::rest-api-reference.adoc[Content Organization and Conventions].
