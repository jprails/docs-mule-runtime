...
[WARNING]
If you plan to connect to an external web service that exposes a WSDL file, the recommended connector to use is the xref:3.8@connectors::web-service-consumer.adoc[Web Service Consumer].
...
* xref:api-usage/proxying-web-services.adoc[Creating a proxy for existing Web services] (for example, adding security to an existing Web service)
