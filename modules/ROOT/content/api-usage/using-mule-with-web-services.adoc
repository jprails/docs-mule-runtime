...
:page-aliases: using-mule-with-web-services.adoc
:keywords: cxf

[WARNING]
If you plan to connect to an external web service that exposes a WSDL file, the recommended connector to use is the xref:3.7@connectors::web-service-consumer.adoc[Web Service Consumer].
...
* xref:3.6@api-usage/proxying-web-services.adoc[Creating a proxy/gateway to existing Web services] (for example, adding security to an existing Web service)
...
For more information, you can check the xref:3.6@modules/consuming-web-services-with-cxf.adoc[Consuming Web Services with CXF] documentation.
...
For more information, read the xref:3.6@modules/consuming-web-services-with-cxf.adoc[Consuming Web Services with CXF] documentation.
...
* xref:3.6@modules/consuming-web-services-with-cxf.adoc[Use the JAX-WS Client API].
* xref:3.6@modules/consuming-web-services-with-cxf.adoc[Build a Client Proxy].
...
For more information, read the xref:3.6@modules/building-web-services-with-cxf.adoc[Creating a JAX-WS Service] documentation.
...
For more information, read the xref:3.6@modules/building-web-services-with-cxf.adoc[Creating a WSDL First JAX-WS Service] documentation.
...
For more information, read the xref:3.6@modules/building-web-services-with-cxf.adoc[Creating a simple front-end Web service] documentation.
...
* xref:3.6@modules/proxying-web-services-with-cxf.adoc[Server-side Proxying]
* xref:3.6@modules/proxying-web-services-with-cxf.adoc[Client-side Proxying]

=== Web Service Proxy Pattern

For simple use cases, you may consider using the xref:3.5@web-service-proxy-pattern.adoc[Web Service Proxy Pattern], particularly when you don't need to accomplish much message processing. From Mule, you can use xref:3.5@configuration-patterns.adoc[Using Mule Configuration Patterns] to configure (with minor XML configuration) a specific integration feature.

== References

For more information and complete documentation, please read the following:

* xref:3.6@modules/cxf-module-reference.adoc[CXF Module Reference]
* xref:3.7@modules/supported-web-service-standards.adoc[Supported Web Service Standards]
* xref:3.5@web-service-proxy-pattern.adoc[Web Service Proxy Pattern]
* Examples
** Echo Example
** Bookstore Example