...
* xref:api-usage/proxying-web-services.adoc[Creating a proxy to existing Web services] (for example, adding security to an existing Web service)
...
. Generate a CXF client using the https://cwiki.apache.org/confluence/display/CXF20DOC/WSDL+to+Java[WSDL to Java] tool from CXF or the https://cwiki.apache.org/confluence/pages/viewpage.action?pageId=2853210[Maven plugin].
...
For more information, you can check the xref:modules/consuming-web-services-with-cxf.adoc[Consuming Web Services with CXF] documentation.
...
For more information, read the xref:modules/consuming-web-services-with-cxf.adoc[Consuming Web Services with CXF] documentation.
...
* xref:modules/consuming-web-services-with-cxf.adoc[Use the JAX-WS Client API].
* xref:modules/consuming-web-services-with-cxf.adoc[Build a Client Proxy].
...
For more information, read the xref:modules/building-web-services-with-cxf.adoc[Creating a JAX-WS Service] documentation.
...
For more information, read the xref:modules/building-web-services-with-cxf.adoc[Creating a WSDL First JAX-WS Service] documentation.
...
For more information, read the xref:modules/building-web-services-with-cxf.adoc[Creating a simple front-end Web service] documentation.
...
* xref:modules/proxying-web-services-with-cxf.adoc[Server-side Proxying]
* xref:modules/proxying-web-services-with-cxf.adoc[Client-side Proxying]
