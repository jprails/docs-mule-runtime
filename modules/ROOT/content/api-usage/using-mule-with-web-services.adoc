...
[WARNING]
If you plan to connect to an external web service that exposes a WSDL file, the recommended connector to use is the xref:3.6@connectors::web-service-consumer.adoc[Web Service Consumer].
