...
* Learn more about xref:api-usage/publishing-a-soap-api.adoc[Publishing a SOAP API] with CXF
...
* For more information on this new connector, see xref:3.5@connectors::web-service-consumer.adoc[Web Service Consumer] .
* For a complete configuration reference, see xref:3.5@connectors::web-service-consumer-reference.adoc[Web Service Consumer Reference].
...
* Follow the xref:apikit::apikit-tutorial.adoc[APIkit Tutorial] to publish a sample RAML-based API.
...
* xref:api-usage/consuming-a-rest-api.adoc[Consuming REST APIs] with HTTP
* Build a connector with xref:3.5@connector-devkit::index.adoc[Anypoint Connector DevKit]
...
* Check out these https://blogs.mulesoft.com/dev/mule-dev/tag/web-services/[blog posts] about exposing and consuming web services with Mule.