...
* For more information on this new connector, see xref:3.7@connectors::web-service-consumer.adoc[Web Service Consumer] .
* For a complete configuration reference, see xref:3.7@connectors::web-service-consumer-reference.adoc[Web Service Consumer Reference].
