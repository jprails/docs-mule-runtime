...
Many APIs require that you pass custom headers along with your requests, such as your developer key. You can set these headers on your messages by adding them as xref:configuring-properties.adoc[properties] before your message reaches the HTTP outbound endpoint.
...
+
image::api-usage/rest-prop2.png[]
+
You can also use a xref:3.7@configuring-properties.adoc[property placeholder], then define the value in your **mule-app.properties** file.
+
image::api-usage/rest-prop3.png[]
...
+
image::api-usage/rest-http-3.png[]
...
+
image::api-usage/http-choose-global.png[]

. Click the *Security* tab.
+
image::api-usage/http-clicksecurity.png[HTTP-clicksecurity]
...
+
image::api-usage/http-userpass.png[]
...
+
image::api-usage/http-userpass-props.png[]
...
+
image::api-usage/consume-rest-datamapper.png[]


== See Also

* See some xref:3.6@api-usage/rest-api-examples.adoc[example applications] that consume REST APIs.
