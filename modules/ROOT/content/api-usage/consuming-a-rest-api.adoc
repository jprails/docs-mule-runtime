...
:page-aliases: consuming-a-rest-api.adoc
...
image::api-usage/consuming-a-rest-api-cd210.png[consuming-a-rest-api-cd210AA]
...
. Click image:api-usage/add.png[] next to Connector Configuration to create a new xref:global-elements.adoc[global element] that encapsulates configuration parameters for the connector.
. Set the Host to *api.openweathermap.org* and the Port to *80*.
+
image::api-usage/consuming-a-rest-api-add1e.png[]
...
+
image::api-usage/consuming-a-rest-api-b33ed.png[]
...
You can use the xref:dataweave/index.adoc[Transform Message component] or a JSON-to-Object transformer to transform this response into another format from which you can extract information, such as route messages.
...
+
image::api-usage/consuming-a-rest-api-52bdc.png[]
...
+
image::api-usage/consuming-a-rest-api-10816.png[]
+
...
image::api-usage/consuming-a-rest-api-e27b0.png[]
...
image::api-usage/consuming-a-rest-api-6147d.png[]
...
+
image::api-usage/consuming-a-rest-api-a9a95.png[]
...
image::api-usage/consuming-a-rest-api-ee3ac.png[]
...
If the REST API you are consuming requires incoming requests arrive via HTTPS, you can configure a global HTTPS connector in your Mule application, then reference the connector in your outbound endpoint. In this example, you create a Java keystore file (JKS) and xref:3.8@connectors::tls-configuration.adoc[configure TLS].

First, configure the HTTP connector for HTTPS:

image::api-usage/consuming-a-rest-api-ba463.png[]
...
. Open the *Properties Editor* of the *HTTP connector* that you have configured to use HTTPS, and click image:api-usage/consuming-a-rest-api-3467e.png[] next to the connector configuration field.
...
+
image::api-usage/consuming-a-rest-api-b0370.png[]
...
. Click  image:api-usage/consuming-a-rest-api-3467e.png[] next to the connector configuration field, then select the *Authentication* tab.
...
+
image::api-usage/consuming-a-rest-api-4f8c3.png[]
+
...
+
image::api-usage/consuming-a-rest-api-b88bf.png[]


*POST requests and the API schema*

If you are calling a REST API with a POST request, you need to obtain the API schema for the POST and match that format in the payload of the Mule message that you send to the API with your request. A good way to do this is to insert a xref:dataweave/index.adoc[Transform Message component] before the HTTP outbound endpoint in your flow, then define the output format in the properties editor.

image::api-usage/consuming-a-rest-api-b372e.png[]