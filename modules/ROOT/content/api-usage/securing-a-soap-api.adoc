...
To the Mule flow that involves an API, add a xref:components/cxf-component-reference.adoc[*CXF Component*] to publish, consume, or proxy an API. Complete the following steps to configure WS-security on the CXF component.
