...
To the Mule flow that involves an API, add a xref:components/cxf-component-reference.adoc[*CXF Component*] to publish, consume, or create a proxy for an API. Complete the following steps to configure WS-security on the CXF component.
...
* The string value is one of the following constants: ** https://ws.apache.org/wss4j/apidocs/org/apache/wss4j/dom/WSConstants.html[WSConstants], a class to define the kind of access the server allows
...
. Click image:api-usage/add.png[(plus)] in *Add Configuration Element* to create a new key-value pair.
+
image::api-usage/securing-a-soap-api-063ca.png[]
+
...
+
image::api-usage/securing-a-soap-api-52d2b.png[]
+
...
+
image::api-usage/securing-a-soap-api-1f421.png[]
+
...
image:api-usage/add.png[(plus)] button to open a new properties panel for creating and configuring a new bean. The bean imports the Java class you have built to specify the custom validator override behavior.
+
image::api-usage/securing-a-soap-api-d8161.png[]
+
. Click *OK*.
