...
|*Anypoint Connectors* |Need to connect to a SaaS application? Check our http://www.mulesoft.org/connectors[library of Anypoint Connectors], and add them your instance of Mule. 2+|xref:3.7@connectors::installing-connectors.adoc[Installing Connectors]
...
If you find that your integration development team regularly requires functionality not included with Mule out of the box, you can make use of the extensive xref:3.7@connector-devkit::index.adoc[Anypoint Connector DevKit] to build your own extensions.
