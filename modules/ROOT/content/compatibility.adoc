...
See xref:install/hardware-and-software-requirements.adoc[Hardware and Software Requirements] for information about hardware, operating systems, JDEs, and other software required to run Mule ESB, Mule Management Console, or Mule Studio.

xref:install/installing.adoc[Which version of Mule an I using?]
...
* xref:install/installing-an-enterprise-license.adoc[Enterprise Edition license].
* xref:5@studio::studio-in-eclipse.adoc[Mule Studio as an Eclipse plug-in]