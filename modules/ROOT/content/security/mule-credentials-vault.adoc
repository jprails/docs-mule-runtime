...
* Access the xref:security/anypoint-enterprise-security-example-application.adoc[example application] which demonstrate Mule Enterprise Security in action.