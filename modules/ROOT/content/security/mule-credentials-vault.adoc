...
* Access the xref:3.6@security/anypoint-enterprise-security-example-application.adoc[example application] which demonstrate Anypoint Enterprise Security in action.