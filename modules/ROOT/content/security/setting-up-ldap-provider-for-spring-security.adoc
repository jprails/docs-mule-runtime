...
* As its security provider via http://www.mulesoft.org/docs/site/current/3.6.0/org/mule/module/spring/security/SpringProviderAdapter.html[SpringProviderAdapter]
