...
Install the xref:3.6@security/installing-anypoint-enterprise-security.adoc[Anypoint Enterprise Security update] on your instance of Anypoint Studio Enterprise Edition 3.3.2 or later.
...
* xref:3.6@security/configuring-the-spring-security-manager.adoc[Mule Security Manager], client authentication and authorization on inbound requests as well as credential mapping for outbound calls
* xref:3.7@security/setting-up-ldap-provider-for-spring-security.adoc[LDAP] and third party identity management system integration
* xref:3.6@modules/enabling-ws-security.adoc[Validation of inbound requests] through the SAML 2.0 federated identity standard
* xref:3.7@transports/sftp-transport-reference.adoc[Secure FTP (SFTP) Transport] that enables Mule flows to read and write to remote directories over the SSH protocol.
...
xref:3.8@security/mule-secure-token-service.adoc[Apply Oauth 2.0 to my Mule Web service provider] +
xref:3.8@security/mule-secure-token-service.adoc[Apply Oauth 2.0 to my Mule Web service consumer]
...
xref:3.6@security/mule-credentials-vault.adoc[Encrypt a properties file]
...
xref:3.6@security/mule-message-encryption-processor.adoc[Encrypt a message payload] +
xref:3.6@security/mule-message-encryption-processor.adoc[Decrypt a message payload]
...
xref:3.7@security/mule-digital-signature-processor.adoc[Add a digital signature to a message in Mule] +
xref:3.7@security/mule-digital-signature-processor.adoc[Sign part of a message payload] +
xref:3.7@security/mule-digital-signature-processor.adoc[Verify a digital signature in Mule]
...
xref:3.7@security/anypoint-filter-processor.adoc[Filter unsecure messages]
...
xref:3.6@security/mule-crc32-processor.adoc[Apply a CRC to a message] +
 +

== See Also

. Install the xref:3.6@security/installing-anypoint-enterprise-security.adoc[Anypoint Enterprise Security update] on your instance of Anypoint Studio or Standalone Enterprise 3.3.2 or later.
...
** xref:3.6@security/anypoint-enterprise-security-example-application.adoc[Anypoint Enterprise Security Example Application]
** xref:3.7@security/mule-sts-oauth-2.0-example-application.adoc[Mule STS Oauth 2.0 Example Application]