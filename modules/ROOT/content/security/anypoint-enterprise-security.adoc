...
Install the xref:security/installing-anypoint-enterprise-security.adoc[Anypoint Enterprise Security update] on your instance of Mule Studio Enterprise Edition 3.3.2.
...
xref:mule-filter-processor.adoc[Filter unsecure messages]
