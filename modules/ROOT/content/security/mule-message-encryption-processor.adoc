...
[NOTE]
Because of its increased complexity, the topic has earned its own page: refer to the xref:security/pgp-encrypter.adoc[PGP Encrypter] document.
...
* http://docs.oracle.com/javase/8/docs/technotes/guides/security/crypto/CryptoSpec.html[Java Cryptography Architecture (JCA)]
* http://www.pgpi.org[Pretty Good Privacy (PGP)]