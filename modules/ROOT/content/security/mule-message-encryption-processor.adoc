...
+
image::security/jceencryption2.png[JCEencryption2]
+
...
Next, create an Encryption global element by clicking the image:security/add.png[(plus)] icon next to the *Config Reference* field. In the Global Element Properties window:

image::security/globalencryption1.png[GlobalEncryption1]
