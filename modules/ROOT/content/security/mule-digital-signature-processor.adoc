...
:page-aliases: mule-digital-signature-processor.adoc
...
As Mule’s default signature strategy, the http://docs.oracle.com/javase/8/docs/technotes/guides/security/crypto/CryptoSpec.html[Java Cryptology Extension (JCE)] signer, part of the Java Cryptography Architecture (JCA), enriches a message payload with a digital signature.
...
+
image::security/global-jce-signer-both.png[global_JCE_Signer_both]
+
...
+
image::security/signature-1.png[signature+1]
+
[%header%autowidth.spread]
|===
|Field |Req'd |Value
...
+
image::security/global-xml-signer-both.png[global_XML_Signer_Both]
+
[%header,cols="34,33,33"]
|===
|Field |Req'd |Value
...
image::security/enable-language3.png[enable_language3]
...
Examine the xref:security/anypoint-enterprise-security-example-application.adoc[Anypoint Enterprise Security Example Application] which illustrates how to verify the digital signature of a message.
