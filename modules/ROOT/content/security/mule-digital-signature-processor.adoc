...
+
image::security/jce-sign1.png[JCE_sign1]
+
...
+
image::security/global-jce-general.png[global_JCE_general]
+
...
+
image::security/global-jce-signer3.png[global_JCE_Signer3]
+
...
+
image::security/xml-signature.png[xml_signature]
+
...
+
image::security/xml-global-signature.png[XML_global_signature]
+
...
+
image::security/xml-global-attributes.png[XML_Global_attributes]
...
Then, add a *message attribute* to an element in your flow, a Logger, for example, to apply a digital signature according to the configurations in the Global Signature element. +
 +
 image:security/add-message.png[add_message]
