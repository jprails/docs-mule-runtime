...
:page-aliases: jaas-security.adoc

The https://www.mulesoft.org/docs/site/current/apidocs/org/mule/module/jaas/JaasSimpleAuthenticationProvider.html[JaasSimpleAuthenticationProvider] is a security provider that provides a way to interact with the Jaas Authentication Service.
