...
* xref:security/component-authorization-using-spring-security.adoc[Securing Flow Components]
* xref:security/component-authorization-using-spring-security.adoc[Setting Security Properties on the Security Provider]
...
In addition to the `daoAuthenticationProvider` and `inMemoryDaoImpl` beans (see xref:security/configuring-security.adoc[Configuring Security]), the following beans must be configured:
