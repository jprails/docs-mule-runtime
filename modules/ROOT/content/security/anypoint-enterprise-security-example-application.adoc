...
+
image::security/full-example-flow.png[]
...
image::security/example-signature-1.png[]
...
* For more information on encryption in Mule, refer to xref:security/mule-message-encryption-processor.adoc[Mule Message Encryption Processor].
* For more information on signatures in Mule, refer to xref:security/mule-digital-signature-processor.adoc[Mule Digital Signature Processor].