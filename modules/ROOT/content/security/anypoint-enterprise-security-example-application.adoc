...
It also assumes you are familiar with the xref:5@studio::index.adoc[Anypoint Studio] interface. To increase your familiarity with Studio, consider completing one or more xref:general:getting-started:index.adoc[Anypoint Studio Quickstarts].
