...
This document assumes that you are familiar with the xref:5@studio::index.adoc[Mule Studio Essentials] guide. To increase your familiarity with Studio, consider completing the xref:5@studio::basic-studio-tutorial.adoc[Basic Studio Tutorial].
...
+
image::security/mule-enterprise-security-example.png[mule_enterprise_security_example]
...
image::security/verify-signature1.png[verify_signature1]
...
image::security/encrypt-cc-info.png[encrypt_cc_info]
...
image::security/decrypt-xml.png[decrypt_XML]
...
* For more information on encryption in Mule, refers to xref:security/mule-message-encryption-processor.adoc[Mule Message Encryption Processor].
