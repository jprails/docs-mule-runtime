...
This document assumes that you are familiar with xref:essentials-of-using-mule-esb-3.adoc[Mule ESB] and the xref:mule-studio-essentials.adoc[Mule Studio] interface. To increase your familiarity with Studio, consider completing one or more xref:getting-started-with-mule-studio.adoc[Mule Studio Tutorials].
...
+
image::security/mule-enterprise-security-example.png[]
...
image::security/verify-signature.png[]
...
image::security/global-signature.png[]
====
...
+
image::security/global-xml-encrypt.png[]
...
image::security/get-cc-info-response.png[]
...
image::security/decrypt-xml.png[]
...
image::security/get-secret-file-response.png[]
