...
:page-aliases: anypoint-enterprise-security-example-application.adoc
...
This document assumes that you have xref:security/installing-anypoint-enterprise-security.adoc[installed the Anypoint Enterprise Security] extensions.

It also assumes you are familiar with the xref:6@studio::index.adoc[Anypoint Studio] interface. To increase your familiarity with Studio, consider completing one or more xref:general:getting-started:index.adoc[Anypoint Studio Quickstarts].
...
The *Encrypted Message Producer* application consists of three simple xref:flows/index.adoc[flows], each of which acts as a Web service provider which encrypts or decrypts a message before returning a response to the caller. Organized according to function, these flows serve different purposes within the application.
...
+
image::security/full-example-flow.png[full+example+flow]
...
Make sure to right click on any of the xref:security/mule-message-encryption-processor.adoc[Mule Message Encryption Processors] and select `Add Encryption libraries to the project`.

image::security/add-encryption-libraries.png[]
...
image::security/example-signature-1.png[example+signature+1]
...
image::security/global-signature.png[global_signature]
...
+
image::security/global-xml-encrypt.png[global_XML_encrypt]
...
image::security/get-cc-info-response.png[get_cc_info_response]
...
image::security/get-secret-file-response.png[get_secret_file_response]

== See Also

* For more information on encryption in Mule, see xref:security/mule-message-encryption-processor.adoc[Mule Message Encryption Processor].
* For more information on signatures in Mule, see xref:security/mule-digital-signature-processor.adoc[Mule Digital Signature Processor].
