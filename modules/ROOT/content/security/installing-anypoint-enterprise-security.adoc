...
* Refer to the xref:release-notes::anypoint-enterprise-security/release-notes.adoc[Anypoint Enterprise Security Release Notes] for details about what is included in the current version.
