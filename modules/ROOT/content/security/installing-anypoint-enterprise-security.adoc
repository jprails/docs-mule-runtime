...
image::security/launch-studio.png[launch_Studio]
====
+
...
* xref:security/anypoint-enterprise-security-example-application.adoc[Anypoint Enterprise Security Example Application] demonstrates Mule Enterprise Security features in action.