...
* If you've already downloaded Anypoint Enterprise Security version 1.1 onto your instance of Mule Studio, follow the procedure below to update to version 1.2. (Not sure which version of Anypoint Enterprise Security you have installed? xref:5@studio::installing-extensions.adoc[Find out].)
...
+
image::security/studio-launch.png[Studio_launch]
====
