...
|image:components/flow-reference-icon.png[]
|Flow Reference
...
See the xref:flows/flow-reference-component-reference.adoc[Flow Reference Component Reference].
|image:components/logger-icon.png[]
|Logger
...
See the xref:components/logger-component-reference.adoc[Logger Component Reference]
|===
...
|===
|  |Components |Description
|image:components/groovy-component-icon.png[groovy-component-icon.png] |Groovy |Facilitates the integration of a custom script backed by the Groovy script engine.

See the xref:components/groovy-component-reference.adoc[Groovy Component Reference].
|image:components/java-component-icon.png[] |Java |Allows you to select a Java class to be invoked by the application flow.

See xref:components/java-component-reference.adoc[Java Component].
|image:components/javascript-component-icon.png[] |JavaScript |Allows integration of a custom script backed by the JavaScript engine.

See the xref:components/javascript-component-reference.adoc[JavaScript Component Reference].
|image:components/python-component-icon.png[] |Python |Allows integration of a custom script backed by the Python script engine.

See the xref:components/python-component-reference.adoc[Python Component Reference].
|image:components/ruby-component-icon.png[] |Ruby |Allows integration of a custom script backed by the Ruby script engine.

See the xref:components/ruby-component-reference.adoc[Ruby Component Reference].
|image:components/script-component-icon.png[] |Script |Makes a script written in Groovy, JavaScript, Python, or Ruby available to the application flow.

See the xref:components/script-component-reference.adoc[Script Component Reference].
|===
...
|===
|  |Components |Description
|image:components/rest-component-icon.png[] |REST |Makes a REST web service available to the application flow via Jersey.

See the xref:components/rest-component-reference.adoc[REST Component Reference].
|image:components/cxf-component-icon.png[] |CXF |Makes a web service available to the application flow via CXF.

See the xref:components/cxf-component-reference.adoc[CXF Component Reference].
|===