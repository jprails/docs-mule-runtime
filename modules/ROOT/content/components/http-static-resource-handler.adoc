...
:page-aliases: http-static-resource-handler.adoc
...
+
image::components/httpstaticblah.png[]
+
...
+
image::components/http-static.png[]
+
...
+
image::components/hello-mules.png[]
+
...
* Add some xref:routers/choice-flow-control-reference.adoc[conditional logic] to your flow xref:routers/routers.adoc[routers].