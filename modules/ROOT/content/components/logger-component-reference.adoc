...
image::components/logger-icon-big.png[]

*Properties*:

image::components/logger.png[]
...
For instructions on how to edit these settings, see xref:debug/logging-in-mule.adoc[Logging in Mule].
...
image::components/logger-flow.png[]
...
* Read more about xref:debug/logging-in-mule.adoc[Logging in Mule].
* Check the xref:mel/mule-expression-language-mel.adoc[Mule Expression Language] reference for more ideas on how to format helpful logger messages.