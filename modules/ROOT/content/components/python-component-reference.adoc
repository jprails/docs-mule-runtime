...
* Refer to the generic xref:components/script-component-reference.adoc[Script Component Reference] to see how a script works with one-way and request-response endpoints.
