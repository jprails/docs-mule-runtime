...
:page-aliases: script-component-reference.adoc
...
[TIP]
Keep in mind that if you'd rather code in Java, there's also a xref:3.7@components/java-component-reference.adoc[Java Component] that works very similarly.

image::components/basic-conf.png[basic+conf]
...
image::components/advanced-conf.png[advanced+conf]
...
* For more information see the Mule ESB page xref:3.6@modules/scripting-module-reference.adoc[Scripting Module]
* Read more about the xref:3.6@components/javascript-component-reference.adoc[JavaScript Component]
* Read more about the xref:3.6@components/ruby-component-reference.adoc[Ruby Component]
* Read more about the xref:3.7@components/groovy-component-reference.adoc[Groovy Component]
* Read more about the xref:3.7@components/python-component-reference.adoc[Python Component]
* Read more about the xref:3.7@components/java-component-reference.adoc[Java Component]