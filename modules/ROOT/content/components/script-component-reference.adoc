...
[TIP]
Keep in mind that if you'd rather code in Java, there's also a xref:components/java-component-reference.adoc[Java Component] that works very similarly.
...
* Read more about the xref:components/javascript-component-reference.adoc[JavaScript Component]
* Read more about the xref:components/ruby-component-reference.adoc[Ruby Component]
* Read more about the xref:components/groovy-component-reference.adoc[Groovy Component]
* Read more about the xref:components/python-component-reference.adoc[Python Component]
* Read more about the xref:components/java-component-reference.adoc[Java Component]