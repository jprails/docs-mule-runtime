...
Refer to the generic xref:3.4@components/script-component-reference.adoc[Script Component Reference] page to see how a script works with one-way and request-response endpoints.
