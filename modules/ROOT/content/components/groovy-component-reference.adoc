...
image::components/groovy2way.png[Groovy2way]
...
image::components/groovy1way.png[Groovy1way]

Refer to the generic xref:components/script-component-reference.adoc[Script Component Reference] page to see how a script works with one-way and request-response endpoints.
...
image::components/groovypropgen.png[GroovyPropGen]
...
image::components/groovypropadv2.png[GroovyPropAdv2]
...
image::components/groovypropdoc.png[GroovyPropDoc]
