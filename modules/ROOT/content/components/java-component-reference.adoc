...
[TIP]
If all you really want to do with your java class is to modify the Payload of the message in some way, you're probably better off using a xref:transformers/java-transformer-reference.adoc[Java Transformer] rather than a Java Component.
...
image::components/java-component.png[java+component]
...
image::components/java-general.png[java_general]
...
image::components/java-object.png[java_object]
...
image::components/java-advanced.png[java_advanced]
...
image::components/advanced-custom.png[advanced_custom]
...
+
image::components/java-component.jpg[java+component]
+
