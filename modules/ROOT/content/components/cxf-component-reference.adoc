...
:page-aliases: cxf-component-reference.adoc
...
* Learn more about xref:api-usage/publishing-a-soap-api.adoc[publishing SOAP APIs] with Mule.

* Learn more about xref:api-usage/consuming-a-soap-api.adoc[consuming SOAP APIs] with Mule.