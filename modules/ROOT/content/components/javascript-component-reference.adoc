...
:page-aliases: javascript-component-reference.adoc

image::components/javascript-component-48x32.png[]
...
image::components/javascript2way.png[Javascript2way]
...
image::components/javascript1way.png[Javascript1way]
...
image::components/javascriptpropgen.png[JavascriptPropGen]
...
Use the *Advanced* tab to optionally configure interceptors and (depending on the interceptor) enter Spring values. You also have the option to specify script properties, which are key/value pairs used to alter or change properties in the script. See the xref:3.4@components/script-component-reference.adoc[Script Component Reference] page for information on using the advanced tab.

image::components/javascriptpropadv2.png[JavascriptPropAdv2]
...
image::components/javascriptpropdoc.png[JavascriptPropDoc]
