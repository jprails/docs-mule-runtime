...
[TIP]
Placing a JavaScript Component is actually the same as placing a xref:components/script-component-reference.adoc[Script component] and then selecting the JavaScript engine.
...
image::components/javascript-general.png[javascript_general]
...
image::components/javascript-advanced.png[javascript_advanced]
