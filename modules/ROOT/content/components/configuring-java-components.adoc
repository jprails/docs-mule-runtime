...
Java is the default component type in Mule. Mule provides two https://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/api/component/JavaComponent.html[JavaComponent] implementations:
...
[%autowidth.spread]
|===
|<prototype-object class=..."/> |https://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/object/PrototypeObjectFactory.html[PrototypeObjectFactory]
|<singleton-object class=..."/> |https://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/object/SingletonObjectFactory.html[SingletonObjectFactory]
|<spring-object bean=..."/> |https://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/config/spring/util/SpringBeanLookup.html[SpringBeanLookup]
|===
