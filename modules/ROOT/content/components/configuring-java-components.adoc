...
:page-aliases: configuring-java-components.adoc
:keywords: connectors, anypoint, studio, java, java components, components

Java is the default component type in Mule. Mule provides two https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/api/component/JavaComponent.html[JavaComponent] implementations:
...
[%autowidth.spread]
|===
|<prototype-object class=..."/> |https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/object/PrototypeObjectFactory.html[PrototypeObjectFactory]
|<singleton-object class=..."/> |https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/object/SingletonObjectFactory.html[SingletonObjectFactory]
|<spring-object bean=..."/> |https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/config/spring/util/SpringBeanLookup.html[SpringBeanLookup]
|===
...
For a real-world example of using `<spring-object/>`, see xref:spring-integration/using-spring-beans-as-flow-components.adoc[Using Spring Beans as Flow Components].
...
You can configure entry point resolvers that determine how your component is invoked when a message is received by the flow. See xref:components/developing-components.adoc[Developing Components] for a more detailed description of their functionality.
...
See xref:components/developing-components.adoc[Developing Components] for more information about lifecycles.
...
Binding can be used on Java components and script components. For more information see xref:components/component-bindings.adoc[Component Bindings].

== Configuring a Pooled Java Component

A pooled Java component maintains a pool of object instances that are reused, with a single instance being used by one thread at any one time. The configuration of component pooling is independent of the object factory, allowing you to use whichever object factory you need.
...
For more information about pooling and reference documentation for pooling configuration options, see xref:administer/tuning-performance.adoc[Tuning Performance].