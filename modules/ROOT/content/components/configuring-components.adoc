...
Service components contain the business logic for working with the messages passed through Mule ESB. A service component can be any type of object, including a xref:using-spring-beans-as-service-components.adoc[Spring bean], xref:components/configuring-java-components.adoc[POJO], xref:modules/scripting-module-reference.adoc[script], xref:api-usage/using-web-services.adoc[web service].
...
|*<script:component/>* |Configures a JSR-223 xref:modules/scripting-module-reference.adoc[script] for the service component.
|===
