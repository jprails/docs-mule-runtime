...
:page-aliases: invoke-component-reference.adoc
...
+
image::components/invoke-create-class.png[]
+
. Name the class `GreetingService`.
+
image::components/create-java-class.png[Create a Java Class]
+
...
+
image::components/invoke-pe.png[Invoke Property Editor with Values]
...
+
image::components/invoke-create-bean.png[]
+
. In the Choose Global Type screen, expand Beans, select *Bean*, and click *OK*.
+
image::components/invoke-select-bean.png[]
+
...
* Learn more about xref:components/components.adoc[other components] available in Mule.