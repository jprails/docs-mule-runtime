...
// [NOTE]
// This document examines the Mule message in the context of a flow rather than a batch job. Please see xref:3.8@batch/batch-processing.adoc[Batch Processing] for more information about how messages in a batch job are broken up and processed as records.
...
image::about/mule-message-structure-82af1.png[]
...
//
// image:about/datasenseexplorericon.png[icon]
//
...
//
// image:about/metadata-explorer.png[metadata]
//
// [TIP]
...
//
// For more information, see xref:6@studio::datasense/using-the-datasense-explorer.adoc[using the DataSense Explorer]
