...
:page-aliases: about-the-xml-configuration-file.adoc

The most common way to configure Mule ESB is with Spring XML files that use custom Mule namespaces. This page describes the format of the file. Note that the XML schema and namespace declarations are filled in automatically when you see the http://www.mulesource.org/display/MULEIDE/Mule+IDE+2.0+User+Guide[Mule IDE].
