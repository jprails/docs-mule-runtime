...
Use a *variable transformer* to set or remove a variable on the message. The scope of this variable is limited to the flow where it is set; when the message leaves the flow, the variable does not carry over to the next flow or application. (By contrast, variables specified through the xref:3.6@transformers/session-variable-transformer-reference.adoc[session variable transformer] persist as long as the message continues to be processed within your Mule application, regardless of flow.) To learn more about message scopes, refer to xref:3.7@concepts/index.adoc[Mule Concepts].
...
+
image::transformers/set-variable.png[set+variable]
...
* Refer to xref:3.7@concepts/index.adoc[Mule Concepts] to learn more about message scopes.
* Read about related transformers, the xref:3.6@transformers/session-variable-transformer-reference.adoc[session variable transformer] and the xref:3.6@transformers/property-transformer-reference.adoc[properties transformer], which you can use to set properties and variables for different scopes.
