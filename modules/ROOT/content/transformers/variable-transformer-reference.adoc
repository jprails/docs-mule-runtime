...
By contrast, _session_ variables specified using the xref:transformers/session-variable-transformer-reference.adoc[Session Variable Transformer] persist as long as the message continues to be processed within your Mule application, regardless of flow. To learn more about message scopes, refer to xref:concepts/index.adoc[Mule Concepts].
...
image::transformers/variable-transformer.png[variable_transformer]
...
+
image::transformers/variable-transformer-example.png[variable+transformer+example]
+
...
+
image::transformers/variable-transformer-reference-0ee31.png[set+variable]
+
...
+
image::transformers/studio-flowvars-logger.png[Studio_FlowVars_Logger]
...
image::transformers/variable-transformer-flow.png[]

[source,xml,linenums]
----
include::{samplesdir}/variable-transformer-reference.xml[]
----

== See Also

* Refer to xref:concepts/index.adoc[Mule Concepts] to learn more about message scopes.
* Read about related transformers, the xref:transformers/session-variable-transformer-reference.adoc[session variable transformer] and the xref:transformers/property-transformer-reference.adoc[properties transformer], which you can use to set properties and variables for different scopes.
