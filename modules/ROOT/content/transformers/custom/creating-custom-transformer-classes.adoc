...
A custom transformer is a user-defined transformer class that implements `org.mule.api.transformer.Transformer.` Your class can extend https://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/transformer/AbstractTransformer.html[`AbstractTransformer`] or https://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/transformer/AbstractMessageTransformer.html[`AbstractMessageTransformer`], depending on your needs. This page describes how to create a custom transformer in more detail.
...
https://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/api/transformer/DiscoverableTransformer.html[org.mule.api.transformer.DiscoverableTransformer]
