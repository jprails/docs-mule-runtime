...
A custom transformer is a user-defined transformer class that implements `org.mule.api.transformer.Transformer`. Your class can extend https://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/transformer/AbstractTransformer.html[`AbstractTransformer`] or https://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/transformer/AbstractMessageTransformer.html[`AbstractMessageTransformer`], depending on your needs. This page describes how to create a custom transformer in more detail.
...
https://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/api/transformer/DiscoverableTransformer.html[org.mule.api.transformer.DiscoverableTransformer]
...
You can find examples in https://www.mulesoft.com/exchange#!/[Anypoint Exchange]. The following example is for a custom transformer called `StringToNameString`, which wraps Java string in a custom class called `NameString`:
