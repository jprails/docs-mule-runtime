...
:page-aliases: outbound-endpoint-transactions.adoc

This page lists the outbound endpoint transactions of the https://mulesoft.github.io/sap-transport/[SAP Connector].
