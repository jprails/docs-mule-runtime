...
image::transformers/connect-sfdc.png[connect_SFDC]
...
* Learn more about the xref:6@studio::datamapper/datamapper-user-guide-and-reference.adoc[DataMapper] transformer.
