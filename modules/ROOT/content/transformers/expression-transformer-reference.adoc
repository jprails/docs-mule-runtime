...
image::transformers/transformer-48x32.png[Transformer-48x32]
...
image::transformers/expression-transformer1.png[]
...
The default value in the *Expression* field is **`#[]`**. You need to type a valid expression within the square brackets. For syntax details see the xref:3.4@mel/mule-expression-language-mel.adoc[Mule Expression Language MEL] documentation.
...
image::transformers/expression-transformer2.png[]
