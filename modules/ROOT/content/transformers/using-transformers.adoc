...
[TIP]
The most powerful tool for transforming a message is the xref:dataweave/index.adoc[DataWeave Transformer], which can not only change the format of the message, but also rename, aggregate, split or rearrange the fields in it in any way you desire.
...
The basic transformers are in the https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transformer/simple/package-summary.html[org.mule.transformer.simple] package. They do not require any special configuration. For details on these transformers, see xref:transformers/transformers-configuration-reference.adoc[Transformers Configuration Reference].
...
The JSON transformers are in the https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/module/json/transformers/package-summary.html[org.mule.module.json.transformers] package. They provide the ability to work with JSON documents and bind them automatically to Java objects. For information, see xref:transformers/native-support-for-json.adoc[Native Support for JSON].

=== Scripting

The xref:modules/scripting-module-reference.adoc[Scripting] transformer transforms objects using scripting, such as JavaScript or http://www.groovy-lang.org/[Groovy] scripts. This transformer is in the https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/module/scripting/transformer/package-summary.html[org.mule.module.scripting.transformer] package.

=== Encryption

The encryption transformers are in the https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transformer/encryption/package-summary.html[org.mule.transformer.encryption] package.
...
The compression transformers are in the https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transformer/compression/package-summary.html[org.mule.transformer.compression] package. They do not require any special configuration.
...
The encoding transformers are in the https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transformer/codec/package-summary.html[org.mule.transformer.codec] package. They do not require any special configuration.
...
The HTTP connector provides several transformers for converting an HTTP response to a Mule message, map or string, and for converting a message to an HTTP request or response. For details, see xref:3.7@connectors::http-connector.adoc[HTTP Connector].
...
*Note*: The JDBC transport has been deprecated and will be removed in Mule version 4. Use the xref:3.7@connectors::database-connector.adoc[Database Connector] instead.
