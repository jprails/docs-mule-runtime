...
image::transformers/studio-attachmentppp.png[Studio_AttachmentPPP]
...
* Read about related transformers, the xref:transformers/property-transformer-reference.adoc[property transformer], the xref:transformers/variable-transformer-reference.adoc[variable transformer]
, and the xref:transformers/session-variable-transformer-reference.adoc[session variable transformer], which you can use to set properties and variables for different scopes.