...
:page-aliases: xslt-transformer-reference.adoc
...
image::transformers/xsltgeneral.png[XSLTGeneral]

== Advanced Tab

Use the Advanced tab to optionally configure additional properties.

image::transformers/xsltadvanced.png[XSLTAdvanced]
...
*Content Properties*: Click the green plus icon image:transformers/add.png[plus] to add a key. This example shows the title and rating for a CD music listing service, which is listed in the code example in the next section.

== Code Example

image::transformers/xslt-transformer-ref-flow.png[]
