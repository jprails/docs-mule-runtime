...
image:transformers/javascript-transformer-24x16.png[] |JavaScript |Implements a JavaScript transformer backed by a JavaScript script engine |xref:3.7@transformers/script-transformer-reference.adoc[Script Transformer Reference]


image:transformers/ruby-transformer-24x16.png[] |Ruby |Implements a script transformer backed by a Ruby script engine |xref:3.7@transformers/script-transformer-reference.adoc[Script Transformer Reference]
...
|image:transformers/java-transformer-24x16.png[] |Java |Transforms the data from one format to another |xref:3.6@transformers/java-transformer-reference.adoc[Java Transformer Reference]
...
|image:transformers/transformer-24x16.png[Transformer-24x16] |Object-to-XML |Converts a Java Object into XML code using XStream |xref:3.7@transformers/object-to-xml-transformer-reference.adoc[Object-to-XML Transformer Reference]
...
|  |Content +
Transformer |Description |Documentation
|image:transformers/transformer-24x16.png[Transformer-24x16] |Append string |Appends a string to a message payload |xref:3.6@transformers/append-string-transformer-reference.adoc[Append String Transformer Reference]


|image:transformers/transformer-24x16.png[Transformer-24x16] |Expression |Evaluates one or more expressions within the message, then transforms the message according to the results of its evaluation |xref:3.7@transformers/expression-transformer-reference.adoc[Expression Transformer Reference]


|image:transformers/transformer-24x16.png[Transformer-24x16] |XSLT |Transforms XML using XSLT |xref:3.7@transformers/xslt-transformer-reference.adoc[XSLT Transformer Reference]
|===
