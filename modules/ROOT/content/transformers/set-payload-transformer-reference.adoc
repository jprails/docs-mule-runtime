...
This transformer sets the payload to whatever you define. The payload can be a literal string or a xref:3.5@mel/mule-expression-language-mel.adoc[Mule Expression].
...
image::transformers/studio-set-payload.png[Studio_set-payload]
...
image::transformers/hello-flow.png[]

image::transformers/studio-setpayload-example.png[Studio_setpayload_example]
...
* See this transformer in action in the xref:3.5@hello-world-example.adoc[Hello World Example].
* Read more about xref:3.5@transformers/transformers.adoc[other transformers] available in Mule.