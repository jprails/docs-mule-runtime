...
This transformer sets the payload to whatever you define. The payload can be a literal string or a xref:3.7@mel/mule-expression-language-mel.adoc[Mule Expression].
...
image::transformers/set-payload-alt.png[set+payload]
...
* See the xref:2.0@exchange::exchange1.adoc[examples].
* Read more about xref:3.7@transformers/transformers.adoc[other transformers] available in Mule.