...
:page-aliases: parse-template-reference.adoc
...
link:{attachmentsdir}/responseHtml.template[responseHtml.template file]
...
* Learn how to use xref:mel/mule-expression-language-mel.adoc[Mule Expression Language (MEL)] to read session variables using the `sessionVars` map.