...
image::transformers/parse-template.png[parse_template]
...
* xref:transformers/variable-transformer-reference.adoc[variable transformer]
* xref:transformers/property-transformer-reference.adoc[properties transformer]