...
JSON transformers have been added to make it easy to work with JSON encoded messages. We have used the excellent https://github.com/codehaus/jackson[Jackson Framework] which means Mule also supports JSON /Object bindings.
