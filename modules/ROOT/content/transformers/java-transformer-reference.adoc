...
To configure Spring bean settings, click the *Add Property* image:transformers/add.png[(plus)] button, then enter a name and its associated value or reference. Spring bean configuration data can be saved in a persistent store and restored at a later time.
...
. click the *Add Property* image:transformers/add.png[(plus)] button

. select the *Advanced* tab
. click the *Add Sub-elements* image:transformers/add.png[(plus)] button
...
* Click the HTTP endpoint *References* tab on the *Properties* pane of your HTTP endpoint instance, then click the add image:transformers/add.png[(plus)] button to the right of the *Connector reference * text box.

* Click the *Global Elements* tab below the *Message Flow* canvas, click the *Create* button, click the image:transformers/add.png[(plus)] next to Connectors, select **HTTP/HTTPS**, then click OK to complete the operation.
...
|===
|Panel |Description
|*Spring Properties* |click the add image:transformers/add.png[(plus)] button to enter the name, value and reference of the *Spring* property you want to define. After the property window appears, click the *Advanced* tab to configure *Spring* sub-element properties.
...
For additional information regarding HTTP configuration, see xref:http-endpoint-reference.adoc[HTTP Endpoint Reference].

For more information, see xref:transformers/custom/creating-custom-transformer-classes.adoc[Creating Custom Transformers].