...
:page-aliases: java-transformer-reference.adoc

image::transformers/java-1.png[Java-1]
...
|===
|image:transformers/information.png[] |The *Java Transformer* was called a *Custom Transformer* in previous versions of Mule ESB.
...
image::transformers/javaexampleflow.png[JavaExampleFlow]
...
image::transformers/javageneraltransformerclass.png[JavaGeneralTransformerClass]
...
To configure Spring bean settings, click the *Add Property* image:transformers/add.png[] button, then enter a name and its associated value or reference. Spring bean configuration data can be saved in a persistent store and restored at a later time.

image::transformers/javageneraltransformerproperty.png[JavaGeneralTransformerProperty]
...
. click the *Add Property* image:transformers/add.png[] button

. select the *Advanced* tab
. click the *Add Sub-elements* image:transformers/add.png[] button

. choose a property element to configure

image::transformers/javageneraltransformeradvanced.png[JavaGeneralTransformerAdvanced]
...
image::transformers/javapropadv.png[JavaPropAdv]
...
image::transformers/javadoc-1.png[JavaDoc-1]
...
image::transformers/httptransformerflow.png[HTTPTransformerFlow]
...
[%header%autowidth.spread]
|===
|image:transformers/information.png[] |You may reuse these Global endpoint and connector references across multiple building block instances within your project. If you decide not use Global references, you must configure HTTP (i.e., Host, Port, and Path, etc.) for the requested resource directly on your HTTP endpoint instance.
...
* Click the HTTP endpoint *References* tab on the *Properties* pane of your HTTP endpoint instance, then click the add image:transformers/add.png[] button to the right of the *Connector reference * text box.

* Click the *Global Elements* tab below the *Message Flow* canvas, click the *Create* button, click the image:transformers/add.png[] next to Connectors, select **HTTP/HTTPS**, then click OK to complete the operation.
...
image::transformers/globalconnectorgen.png[GlobalConnectorGen]
...
image:transformers/arrow-closed-active-16.png[arrow_closed_active_16] Click here for XML Schema Information
...
image:transformers/arrow-closed-active-16.png[arrow_closed_active_16] Click here for XML code
...
image::transformers/globalconnectoradv.png[GlobalConnectorAdv]
...
image::transformers/globalconnectorsec.png[GlobalConnectorSec]
...
image::transformers/globalconnectorprop.png[GlobalConnectorProp]

[%header%autowidth.spread]
|===
|Panel |Description
|*Spring Properties* |click the add image:transformers/add.png[] button to enter the name, value and reference of the *Spring* property you want to define. After the property window appears, click the *Advanced* tab to configure *Spring* sub-element properties.
...
image::transformers/globalconnectorpro.png[GlobalConnectorPro]
...
image::transformers/globalconnectortim.png[GlobalConnectorTim]
...
image::transformers/globalconnectorproxy.png[GlobalConnectorProxy]
...
image::transformers/globalconnectordoc.png[GlobalConnectorDoc]
...
image::transformers/bodytoparametermap.png[BodyToParameterMap]
...
image::transformers/selectmaplookupclass.png[SelectMapLookupClass]
...
image::transformers/javageneraltransformersettings.png[JavaGeneralTransformerSettings]
...
For more information, see the Mule ESB page xref:transformers/custom/creating-custom-transformers.adoc[Creating Custom Transformers]