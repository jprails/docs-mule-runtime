...
The Script Transformer has the same advanced properties as other transformers. Configuring these optional properties is covered in the xref:transformers/script-transformer-reference.adoc[Studio Transformers] page.
