...
:page-aliases: flows-and-subflows.adoc
...
image::flows/standard-synchronous.png[standard_synchronous]

image::flows/standard-asynchronous.png[standard_asynchronous]
...
* In clusters of Mule servers, messages can migrate between nodes when sent to an asynchronous flow. This allows for *load balancing between nodes* and higher performance of application. (See our xref:flows/flow-architecture-advanced-use-case.adoc[advanced use case] for an example.)
...
image::flows/subflow-example.png[subflow_example]
...
image::flows/sync-example.png[sync_example]
...
Read more about setting up xref:scopes/transactional.adoc[Transactional units] in Mule applications.
====
...
image::flows/async-flow-example.png[async_flow_example]
...
|Asynchronous Flow |Flow Reference wrapped within an xref:scopes/async-scope-reference.adoc[Async Scope] |asynchronous |not inherited
|===

== See Also

* *NEXT STEP:* Learn the various ways you can xref:general:getting-started:index.adoc[deploy Mule applications].
* Examine an xref:flows/flow-architecture-advanced-use-case.adoc[advanced use case] showing a more complex flow architecture that uses several child flows.
* Read about some alternative ways to control message processing within a flow using xref:routers/routers.adoc[routing message processors].
* Refer to the xref:flows/flow-reference-component-reference.adoc[Flow Reference Component Reference] and xref:scopes/async-scope-reference.adoc[Async Scope].
* Read more about xref:flows/flow-processing-strategies.adoc[Flow Processing Strategies].
* Read more about setting up xref:scopes/transactional.adoc[transactional units] in Mule applications.