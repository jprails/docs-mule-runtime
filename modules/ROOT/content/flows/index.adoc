...
image::flows/bellsnwhistles.png[BellsnWhistles]
...
image::flows/flowoncanvas.png[FlowOnCanvas]
...
image::flows/threadhandoff.png[ThreadHandoff]
...
image::flows/processingstrategies.png[ProcessingStrategies]
...
image::flows/diagramcatalogapp.png[DiagramCatalogApp]
...
image::flows/studiocatalogapp.png[StudioCatalogApp]

image::flows/xmlcatalogapp.png[XMLCatalogApp]
...
A solid line (below, left) indicates *synchronous* processing along a single thread, which is ideally suited to transactional processing. A dashed line (below, right) indicates simultaneous, parallel, *asynchronous* processing along multiple threads. +
 +
 image:flows/diagramkey.png[DiagramKey]
====
...
image::flows/synchronouschild.png[SynchronousChild]
...
image::flows/subflowreuse.png[SubflowReuse]
...
image::flows/syncchildnotsubflow.png[SyncChildNotSubflow]
...
image::flows/asyncflowref.png[AsyncFlowRef]
...
image::flows/asyncasyncscope.png[AsyncAsyncScope]
...
image::flows/advancedusecase.png[AdvancedUseCase]
...
image::flows/4nodeloadbalancing.png[4NodeLoadBalancing]
