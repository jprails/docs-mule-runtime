...
In addition to fine-tuning the attributes of the queued-asynchronous processing strategy, you can also xref:administer/tuning-performance.adoc[tune performance] of your Mule application by analyzing and configuring thread profiles.
...
* xref:administer/tuning-performance.adoc[Tune performance]
* https://blogs.mulesoft.com/dev/mule-dev/cheat-sheet-asynchronous-message-processing/[MuleSoft Blog]