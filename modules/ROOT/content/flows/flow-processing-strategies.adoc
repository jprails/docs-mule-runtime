...
* The only Message Source that supports non-blocking is the xref:3.7@connectors::http-listener-connector.adoc[HTTP Connector Listener].
* The only Message Processor that supports non-blocking is the xref:3.7@connectors::http-request-connector.adoc[HTTP Connector Request].
