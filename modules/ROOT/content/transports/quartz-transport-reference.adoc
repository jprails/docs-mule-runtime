...
* See the xref:3.5@connectors::quartz-connector.adoc[Quartz Connector] for details on setting the properties for a Quartz endpoint in Studio's visual editor.
