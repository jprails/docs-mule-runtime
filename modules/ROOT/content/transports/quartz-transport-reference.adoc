...
[TIP]
When scheduling tasks, it's recommended that you instead resort to the xref:3.7@scopes/poll-reference.adoc[Poll Scope]
...
* See the xref:3.6@connectors::quartz-connector.adoc[Quartz Connector] for details on setting the properties for a Quartz endpoint in Studio's visual editor.
