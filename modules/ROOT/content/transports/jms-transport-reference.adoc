...
❶ New implementations are recommended to use xref:flows/using-flows-for-service-orchestration.adoc[flows], but Mule 2.x users are more familiar with `<service>`.
