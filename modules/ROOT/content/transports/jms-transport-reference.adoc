...
|JMS |https://www.mulesoft.org/docs/site/current3/apidocs/org/mule/transport/jms/package-summary.html[JavaDoc SchemaDoc] |image:transports/check.png[] |image:transports/check.png[] |image:transports/check.png[] |image:transports/check.png[](client ack, local, XA) | - |image:transports/check.png[] |one-way, request-response |one-way |org.mule.transport:mule-transport-jms
|===
...
* Supports local (JMS), distributed (XA), and multi-resource xref:transactions/transaction-management.adoc[transactions] *Enterprise*
