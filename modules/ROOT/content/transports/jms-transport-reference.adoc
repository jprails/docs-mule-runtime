...
| Doc
| https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transport/jms/package-summary.html[JavaDoc]
...
* Supports local (JMS), distributed (XA), and multi-resource xref:transactions/transaction-management.adoc[transactions]  *_Enterprise_*
...
Inbound = https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transport/jms/transformers/JMSMessageToObject.html[JMSMessageToObject]

Response = https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transport/jms/transformers/ObjectToJMSMessage.html[ObjectToJMSMessage]

Outbound = https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transport/jms/transformers/ObjectToJMSMessage.html[ObjectToJMSMessage]
...
https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transport/jms/package-summary.html[JMS Transport Javadoc]
