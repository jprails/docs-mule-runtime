...
:page-aliases: jms-transport-reference.adoc
...
|JMS |https://www.mulesoft.org/docs/site/current3/apidocs/org/mule/transport/jms/package-summary.html[JavaDoc] http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_jms/namespace-overview.html[SchemaDoc] |image:transports/check.png[] |image:transports/check.png[] |image:transports/check.png[] |image:transports/check.png[](client ack, local, XA) |image:transports/error.png[] |image:transports/check.png[] |one-way, request-response |one-way |org.mule.transport:mule-transport-jms
|===
...
* Supports local (JMS), distributed (XA), and multi-resource xref:transactions/transaction-management.adoc[transactions] _*Enterprise*_
...
*Enterprise*  +
Mule Enterprise includes an xref:transports/mule-wmq-transport-reference.adoc[enhanced transport for WebSphereMQ] which is recommended if you are using WebSphereMQ as your JMS provider.
====
...
https://www.mulesoft.org/docs/site/current/apidocs/org/mule/transport/jms/transformers/JMSMessageToObject.html[JMSMessageToObject]

response =

https://www.mulesoft.org/docs/site/current/apidocs/org/mule/transport/jms/transformers/ObjectToJMSMessage.html[ObjectToJMSMessage]
...
*Enterprise* +
Mule Enterprise includes an xref:3.6@transports/mule-wmq-transport-reference.adoc[enhanced transport for WebSphereMQ] which is recommended if you are using WebSphereMQ as your JMS provider.

http://activemq.apache.org/[ActiveMQ] is also widely-used with Mule and has xref:3.7@transports/activemq-integration.adoc[simplified configuration].
...
* xref:3.6@transports/hornetq-integration.adoc[HornetQ]
* xref:3.7@transports/open-mq-integration.adoc[Open MQ]
* xref:3.7@transports/solace-jms.adoc[Solace JMS]
* xref:3.6@transports/tibco-ems-integration.adoc[Tibco EMS] +
...
https://www.mulesoft.org/docs/site/current/apidocs/org/mule/transport/jms/package-summary.html[JMS Transport Javadoc]
