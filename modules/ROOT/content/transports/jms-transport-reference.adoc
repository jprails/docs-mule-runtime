...
| Doc
| https://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/transport/jms/package-summary.html[JavaDoc]
...
|Streaming
|image:transports/check.png[] (client ack, local, XA)

|Retries
|image:transports/error.png[]
...
Mule Enterprise includes an xref:transports/mule-wmq-transport-reference.adoc[enhanced transport for WebSphereMQ] when using WebSphereMQ as your JMS provider.
====
...
* Inbound = https://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/transport/jms/transformers/JMSMessageToObject.html[JMSMessageToObject]
* Response =
https://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/transport/jms/transformers/ObjectToJMSMessage.html[ObjectToJMSMessage]
* Outbound = https://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/transport/jms/transformers/ObjectToJMSMessage.html[ObjectToJMSMessage]
...
http://activemq.apache.org/[ActiveMQ] is also widely-used with Mule and has xref:transports/activemq-integration.adoc[simplified configuration].
...
* xref:transports/hornetq-integration.adoc[HornetQ]
* xref:transports/open-mq-integration.adoc[Open MQ]
* xref:transports/solace-jms.adoc[Solace JMS]
* xref:transports/tibco-ems-integration.adoc[Tibco EMS]
...
https://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/transport/jms/package-summary.html[JMS Transport Javadoc]
