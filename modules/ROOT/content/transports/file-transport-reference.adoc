...
|Doc |https://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/transport/file/package-summary.html[JavaDoc], http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_file/namespace-overview.html[SchemaDoc] |Javadoc and Schema doc
...
https://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/transport/file/package-summary.html[Javadoc] for File Transport.
