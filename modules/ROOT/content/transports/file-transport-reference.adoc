...
You also can use the following expressions inside attributes (check here for more information):
...
https://www.mulesoft.org/docs/site/3.3.0/apidocs/org/mule/transport/file/package-summary.html[Javadoc for Mule 3.3.0] for File Transport.

https://www.mulesoft.org/docs/site/3.3.1/apidocs/org/mule/transport/file/package-summary.html[Javadoc for Mule 3.3.1] for File Transport.
