...
:page-aliases: file-transport-reference.adoc
...
*Connector Guide*: xref:3.7@connectors::file-connector.adoc[File Connector]
...
|Doc |https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transport/file/package-summary.html[JavaDoc], http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_file/namespace-overview.html[SchemaDoc] |Javadoc and Schema doc
...
For new dateTime functions introduced into MEL with Mule 3.4 and later, see xref:mel/mule-expression-language-date-and-time-functions.adoc[MEL Date and Time Functions].
...
*Note* : In these code examples,  `spring-beans-current.xsd`  is a placeholder. Mule 3.7 and newer uses Spring 4.1.6.
...
*Required*: no +
*Default*: none
|workFileNamePattern |The pattern to use when moving a file to a new location determined by the workDirectory property. You can use the patterns supported by the filename parser configured for this connector.
...
https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transport/file/package-summary.html[Javadoc] for File Transport.
