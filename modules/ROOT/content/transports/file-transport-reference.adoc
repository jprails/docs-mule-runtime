...
For new dateTime functions introduced into MEL with Mule 3.4 and later, see xref:3.6@mel/mule-expression-language-date-and-time-functions.adoc[MEL Date and Time Functions].
