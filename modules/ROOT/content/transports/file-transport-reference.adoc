...
*Connector Guide*: xref:3.8@connectors::file-connector.adoc[File Connector]
...
|Doc |https://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/transport/file/package-summary.html[JavaDoc], http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_file/namespace-overview.html[SchemaDoc] |JavaDoc and Schema doc
...
For new dateTime functions introduced into MEL with Mule 3.4 and newer, see xref:mel/mule-expression-language-date-and-time-functions.adoc[MEL Date and Time Functions].
...
https://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/transport/file/package-summary.html[Javadoc] for File Transport.
