...
|JDBC |[JavaDoc] |check |check |check |check (local XM) |image:transports/error-1.png[] |check |one-way request response |one-way |`org.mule.transport:mule-transport-jdbc`
|===
