...
Access the documentation for the xref:3.7@connectors::database-connector.adoc[Database Connector] to take advantage of the newly-designed functionality.
====
...
*Note*: In code examples in this guide,  `spring-beans-current.xsd` is a placeholder. Mule 3.7 and newer supports Spring 4.1.6.
...
|JDBC |https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transport/jdbc/package-summary.html[JavaDoc] |image:transports/check.png[(tick)] |image:transports/check.png[(tick)] |image:transports/check.png[(tick)] |image:transports/check.png[(tick)](local,XA) |image:transports/error.png[(error)] |image:transports/check.png[(tick)] |one-way, request-response |one-way |org.mule.transport:mule-transport-jdbc
...
https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transport/jdbc/package-summary.html[Javadoc for JDBC Transport]
