...
Access the documentation for the xref:3.6@connectors::database-connector.adoc[Database Connector] to take advantage of the newly-designed functionality.
====
...
|JDBC |https://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/transport/jdbc/package-summary.html[JavaDoc] |image:transports/check.png[(tick)] |image:transports/check.png[(tick)] |image:transports/check.png[(tick)] |image:transports/check.png[(tick)](local,XA) |image:transports/error.png[(error)] |image:transports/check.png[(tick)] |one-way, request-response |one-way |org.mule.transport:mule-transport-jdbc
