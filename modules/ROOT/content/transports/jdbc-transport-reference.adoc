...
Review the xref:3.8@connectors::database-connector.adoc[*Database Connector Documentation*] to read about database connector features and functionality.

*Note:* The Mule 3.8.0  https://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/transport/jdbc/package-summary.html[org.mule.transport.jdbc] package documentation remains available.
====
...
[%autowidth.spread]
|===
|Docs|https://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/transport/jdbc/package-summary.html[JDBC Javadoc]
|Inbound |image:transports/check.png[(tick)]
|Outbound |image:transports/check.png[(tick)]
|Request |image:transports/check.png[(tick)]
|Transactions |image:transports/check.png[(tick)] (local,XA)
|Streaming |image:transports/error.png[(error)]
|Retries |image:transports/check.png[(tick)]
...
https://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/transport/jdbc/package-summary.html[Javadoc for JDBC Transport]
