...
Each transport has a service descriptor that describes what classes are used to construct the transport. For complete information, see xref:3.7@transports/transport-service-descriptors.adoc[Transport Service Descriptors].
