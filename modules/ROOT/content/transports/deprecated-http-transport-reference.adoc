...
[source,xml,linenums]
----
include::{samplesdir}/deprecated-http-transport-reference_1.xml[]
----
...
[source,xml,linenums]
----
include::{samplesdir}/deprecated-http-transport-reference_2.xml[]
----
...
[source,xml,linenums]
----
include::{samplesdir}/deprecated-http-transport-reference_3.xml[]
----
...
[source,xml,linenums]
----
include::{samplesdir}/deprecated-http-transport-reference_4.xml[]
----
...
[source,xml,linenums]
----
include::{samplesdir}/deprecated-http-transport-reference_5.xml[]
----
...
[source,xml,linenums]
----
include::{samplesdir}/deprecated-http-transport-reference_6.xml[]
----
...
* See how to xref:3.8@connectors::migrating-to-the-new-http-connector.adoc[Migrate to the New HTTP Connector]
* Get an overview about the new xref:3.8@connectors::http-connector.adoc[HTTP Connector]
* See a reference about the new xref:3.8@connectors::http-connector-reference.adoc[HTTP Connector Reference]