...
:page-aliases: deprecated-http-transport-reference.adoc
...
The legacy endpoint-based connector will be removed in a future version. See xref:3.7@connectors::http-connector.adoc[HTTP Connector] for more information about the HTTP operation-based connector and how to xref:3.7@connectors::migrating-to-the-new-http-connector.adoc[migrate] your projects to it.
====
...
|HTTP |https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transport/http/package-summary.html[JavaDoc] http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_http/namespace-overview.html[SchemaDoc] |image:transports/check.png[] |image:transports/check.png[] |image:transports/check.png[] |image:transports/error.png[] |image:transports/check.png[] |image:transports/error.png[] |one-way, request-response |request-response |org.mule.transport:mule-transport-http

|HTTPS |https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transport/http/package-summary.html[JavaDoc] http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_https/namespace-overview.html[SchemaDoc] |image:transports/check.png[] |image:transports/check.png[] |image:transports/check.png[] |image:transports/error.png[] |image:transports/check.png[] |image:transports/error.png[] |one-way, request-response |request-response |org.mule.transport:mule-transport-https
...
You can use the xref:transports/https-transport-reference.adoc[HTTPS Transport Reference] to create secure connections over HTTP. If you want to secure requests to your HTTP endpoint, the HTTP connector supports HTTP Basic/Digest authentication methods (as well as the Mule generic header authentication). To configure HTTP Basic, you configure a xref:security/configuring-security.adoc[Security Endpoint Filter] on an HTTP endpoint.
...
You must configure the security manager on the Mule instance against which this security filter authenticates. For information about security configuration options and examples, see xref:security/configuring-security.adoc[Configuring Security]. For general information about endpoint configuration, see xref:endpoints/endpoint-configuration-reference.adoc[Endpoint Configuration Reference].
...
https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transport/http/transformers/HttpRequestBodyToParamMap.html[HttpRequestBodyToParamMap]
...
This connector also accepts all the attributes from the xref:transports/tcp-transport-reference.adoc[TCP connector].
...
The HTTP inbound endpoint attributes override those specified for the xref:endpoints/endpoint-configuration-reference.adoc[default inbound endpoint attributes].
...
The HTTP outbound endpoint attributes override those specified for the xref:endpoints/endpoint-configuration-reference.adoc[default outbound endpoint attributes].
...
The HTTP endpoint attributes override those specified for the xref:endpoints/endpoint-configuration-reference.adoc[default global endpoint attributes].
...
* See how to xref:3.7@connectors::migrating-to-the-new-http-connector.adoc[Migrate to the New HTTP Connector]
* Get an overview about the new xref:3.7@connectors::http-connector.adoc[HTTP Connector]
* See a reference about the new xref:3.7@connectors::http-connector-reference.adoc[HTTP Connector Reference]