...
:page-aliases: sftp-transport-reference.adoc
...
|SFTP |http://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/transport/sftp/package-summary.html[JavaDoc +
] http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_sftp/namespace-overview.html[SchemaDoc] |image:transports/check.png[] |image:transports/check.png[] |image:transports/check.png[] |image:transports/error.png[] |image:transports/check.png[] |image:transports/error.png[] |one-way, request-response |one-way |org.mule.transport:mule-transport-sftp
|===
...
. Create the **sftp.properties** properties file in your Classpath or set your PATH variable to the file's location. For information on specifying SFTP server access information for a username, password, host, and port, using Anypoint Studio, see xref:3.6@connectors::sftp-connector.adoc[SFTP Connector].
...
https://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/transport/sftp/package-summary.html[Javadoc for SFTP Transport]
