...
|===
|Transport |image:transports/check.png[checkmark icon]
|Doc |image:transports/check.png[checkmark icon]
|Inbound |image:transports/check.png[checkmark icon]
|Outbound |image:transports/check.png[checkmark icon]
|Request |image:transports/check.png[checkmark icon]
|Transactions |image:transports/error.png[error icon]
|Streaming |image:transports/check.png[checkmark icon]
|Retries |image:transports/error.png[checkmark icon]
...
+
. Create the *sftp.properties* properties file in your Classpath or set your PATH variable to the file's location. For information on specifying SFTP server access information for a username, password, host, and port, using Anypoint Studio, see xref:3.8@connectors::sftp-connector.adoc[SFTP Connector].
