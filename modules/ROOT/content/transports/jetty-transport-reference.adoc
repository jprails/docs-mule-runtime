...
Jetty endpoints are configured the same way as xref:transports/https-transport-reference.adoc[HTTP endpoints]. Note that the Jetty transport can only be used for inbound endpoints.
