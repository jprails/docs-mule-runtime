...
:page-aliases: jetty-ssl-transport.adoc

The Jetty SSL transport works exactly the same way as the xref:transports/https-transport-reference.adoc[HTTPS Transport Reference] with one additional optional attribute, `configFile`, which allows you to specify the location of the Jetty config file to configure this connector with.
...
If you do not need this level of security, you can use the xref:transports/jetty-transport-reference.adoc[Jetty Transport Reference] instead.