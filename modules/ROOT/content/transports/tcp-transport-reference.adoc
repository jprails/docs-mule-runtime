...
]http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_multicast/namespace-overview.html[SchemaDoc] |image:transports/check.png[] |image:transports/check.png[] |image:transports/check.png[] |image:transports/error.png[] |image:transports/error.png[] |image:transports/error.png[] |one-way, request-response |request-response |org.mule.transport:mule-transport-multicast
...
https://www.mulesoft.org/docs/site/3.6.0/apidocs/org/mule/transport/tcp/package-summary.html[TCP]
