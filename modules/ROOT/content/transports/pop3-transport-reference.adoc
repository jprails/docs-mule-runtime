...
|POP3 |https://www.mulesoft.org/docs/site/current3/apidocs/org/mule/transport/email/package-summary.html[JavaDoc] http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_pop3/namespace-overview.html[SchemaDoc] |image:transports/check.png[] |image:transports/error.png[] |image:transports/check.png[] |image:transports/error.png[] |image:transports/error.png[] |image:transports/error.png[] |one-way |one-way |org.mule.transport:mule-transport-pop3
|POP3S |/docs/site/current3/apidocs/org/mule/transport/email/package-summary.html[JavaDoc] http:///site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_pop3s/namespace-overview.html[SchemaDoc] |image:transports/check.png[] |image:transports/error.png[] |image:transports/check.png[] |image:transports/error.png[] |image:transports/error.png[] |image:transports/error.png[] |one-way |one-way |org.mule.transport:mule-transport-pop3s
|===
...
|===
|Element |Description
|tls-client a|Configures the client key store with the following attributes:
...
|tls-trust-store a|Configures the trust store. The attributes are:
...
* host: the IP address of the POP3 server, such as http://www.mulesoft.com[www.mulesoft.com], localhost, or 127.0.0.1
...
https://www.mulesoft.org/docs/site/current/apidocs/org/mule/transport/email/package-summary.html[Javadoc for POP3 Transport]
