...
:page-aliases: pop3-transport-reference.adoc
...
|Doc |https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transport/email/package-summary.html[POP3 and POP3S JavaDoc],
 http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_pop3/namespace-overview.html[POP3 SchemaDoc], http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_pop3s/namespace-overview.html[POP3S Schemadoc]
...
|Outbound |image:transports/error.png[] |Whether the transport can produce outbound events and be used with an outbound endpoint.
...
|Maven Artifact |org.mule.transport:mule-transport-pop3|The group name a artifact name for this transport in http://maven.apache.org/[Maven]
|===
...
The POP3 connector supports all the xref:transports/configuring-a-transport.adoc[common connector attributes and properties] and the following additional attributes:
...
POP3 and POP3S endpoints include details about connecting to a POP3 mailbox. You xref:endpoints/endpoint-configuration-reference.adoc[configure the endpoints] just as you would with any other transport, with the following additional attributes:
...
For more information about transformers, see the xref:transports/email-transport-reference.adoc[Transformers] section in the Email Transport Reference.

For more information about filters, see the xref:transports/email-transport-reference.adoc[Filters] section in the Email Transport Reference.

== Exchange Patterns / Features of the Transport

See xref:transports/transports-reference.adoc[transport matrix].
...
https://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transport/email/package-summary.html[Javadoc for POP3 Transport]
...
For more information about the limitations, see the xref:transports/email-transport-reference.adoc[Limitations] section in the Email Transport Reference.