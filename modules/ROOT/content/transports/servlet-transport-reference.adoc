...
For more information about using Mule with servlet containers, see xref:3.6@deploy/embedding-mule-in-a-java-application-or-webapp.adoc[Embedding Mule in a Java Application or Webapp].
