...
] http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_xmpp/namespace-overview.html[SchemaDoc] |image:transports/check.png[] |image:transports/check.png[] |image:transports/check.png[] |image:transports/error.png[] |image:transports/error.png[] |image:transports/error.png[] |one-way, request-response |one-way |org.mule.transport:mule-transport-xmpp
...
https://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/transport/xmpp/filters/package-summary.html[org.mule.transport.xmpp.filters]
...
https://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/transport/xmpp/package-summary.html[Javadoc API Reference]
