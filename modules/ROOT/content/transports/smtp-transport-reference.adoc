...
The SMTP connector supports all the xref:3.5@transports/configuring-a-transport.adoc[common connector attributes and properties] and the following optional elements and attributes:
...
For more information about transformers, see the xref:3.5@transports/email-transport-reference.adoc[Transformers] section in the Email Transport Reference.

For more information about filters, see the xref:3.5@transports/email-transport-reference.adoc[Filters] section in the Email Transport Reference.

== Exchange Patterns / Features of the Transport

See the xref:3.5@transports/transports-reference.adoc[transport matrix].
...
For more information about the limitations, see the xref:3.5@transports/email-transport-reference.adoc[Limitations] section in the Email Transport Reference.
