...
* xref:3.7@transports/smtp-transport-reference.adoc[SMTP]
* xref:3.6@transports/imap-transport-reference.adoc[IMAP]
* xref:3.7@transports/pop3-transport-reference.adoc[POP3]
