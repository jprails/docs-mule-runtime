...
:page-aliases: email-transport-reference.adoc
...
* xref:transports/imap-transport-reference.adoc[IMAP]
* xref:transports/pop3-transport-reference.adoc[POP3]
...
The full example code for the bookstore and `errorhandler` examples are included in the full http://www.mulesoft.org/download-mule-esb-community-edition[Mule  distribution].
...
|===
|Filter |Description
|https://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/providers/email/filters/AbstractMailFilter.html[org.mule.providers.email.filters.AbstractMailFilter] |A base filter implementation that must be extended by any other mail filter.
|https://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/providers/email/filters/MailSubjectRegExFilter.html[org.mule.providers.email.filters.MailSubjectRegExFilter] |Applies a regular expression to a Mail Message subject.
|===
