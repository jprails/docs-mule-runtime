...
xref:3.8@connectors::http-connector.adoc[HTTP connector]. For using TLS with the new HTTP Connector and the
xref:3.8@connectors::web-service-consumer.adoc[Web Service Consumer] connector, see
xref:3.8@connectors::tls-configuration.adoc[TLS].
