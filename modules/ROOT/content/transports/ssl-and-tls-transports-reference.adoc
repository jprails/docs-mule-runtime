...
:page-aliases: ssl-and-tls-transports-reference.adoc

//3.2x

The following Mule transports provide access to TCP connections:

* The xref:3.6@transports/tcp-transport-reference.adoc[TCP Transport], which uses the basic TCP transport.
...
* Communicating with an external service that uses low-level unsecured TCP connections? If so, use the xref:3.6@transports/tcp-transport-reference.adoc[TCP] protocol.

* Are you communicating with a flow always located in the same Mule application instance? If so, consider using the xref:transports/vm-transport-reference.adoc[VM transport].

* Is it important that messages be persisted until they can be processed? If so, consider using a persistent transport like xref:transports/jms-transport-reference.adoc[JMS] or xref:3.6@transports/file-transport-reference.adoc[File].

* Are there advantages to a higher-level protocol built on top of TCP, for instance, the request-response features of xref:http-transport-reference.adoc[HTTP], or the store-and-forward features of xref:transports/email-transport-reference.adoc[Email]? If so, use the transport for that protocol instead.

* Is performance the primary concern and it is not important that messages be delivered in the proper order or that the sender is notified if any are lost? If so, use the lighter-weight xref:3.6@transports/udp-transport-reference.adoc[UDP transport] instead.
...
|class |The name of the class that implements the custom protocol |  |See xref:3.6@transports/tcp-transport-reference.adoc[below] for an example of writing a custom protocol
...
Content: complex, 9 attributes, attr. http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-udp_xsd/complexTypes/annotatedType.html#a5[wildcard], 6 elements

Subst.Gr: may substitute for element http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-udp_xsd/elements/abstract-global-endpoint.html[mule:abstract-connector]
...
Content: complex, 13 attributes, attr. http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-udp_xsd/complexTypes/annotatedType.html#a5[wildcard], 16 elements

Subst.Gr: may substitute for element http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-udp_xsd/elements/abstract-global-endpoint.html[mule:abstract-global-endpoint]
...
Subst.Gr: may substitute for element http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-udp_xsd/elements/abstract-global-endpoint.html[mule:abstract-global-connector]
...
Content: complex, 13 attributes, attr. http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule_xsd/complexTypes/annotatedType.html#a5[wildcard], 16 elements

Subst.Gr: may substitute for element http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule_xsd/elements/abstract-outbound-endpoint.html[mule:abstract-outbound-endpoint]
...
a|Content: complex, 13 attributes, attr. http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule_xsd/complexTypes/annotatedType.html#a5[wildcard], 16 elements
...
a|Content: complex, 9 attributes, attr. http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule_xsd/complexTypes/annotatedType.html#a5[wildcard], 6 elements

Defined: globally in http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-udp_xsd/schema-overview.html[mule-udp.xsd]; see http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule-udp_xsd/elements/inbound-endpoint.html#xml_source[XML source]

Includes: definition of 5 http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule_xsd/complexTypes/udpConnectorType.html#a6[attributes]
...
Includes: definition of 2 http://www.mulesoft.org/docs/site/3.3.0/schemadocs/schemas/mule_xsd/complexTypes/udpConnectorType.html#a6[attributes]
...
Reference the https://www.mulesoft.org/docs/site/3.4.0/apidocs/[SSL Javadoc] for this module.
