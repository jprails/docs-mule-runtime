...
|xref:transports/ajax-transport-reference.adoc[AJAX] |https://www.mulesoft.org/docs/site/3.4.0/apidocs/org/mule/transport/ajax/package-summary.html[JavaDoc], http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_ajax/namespace-overview.html[SchemaDoc] |image:transports/check.png[] |image:transports/check.png[] |image:transports/error.png[] |image:transports/error.png[] |image:transports/check.png[] |image:transports/error.png[] |one-way |one-way |org.mule.transport:mule-transport-ajax

|Axis |https://www.mulesoft.org/docs/site/3.4.0/apidocs/org/mule/transport/axis/package-summary.html[JavaDoc]http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_axis/namespace-overview.html[SchemaDoc]
...
|xref:transports/file-transport-reference.adoc[File] |https://www.mulesoft.org/docs/site/3.4.0/apidocs/org/mule/transport/file/package-summary.html[JavaDoc]http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_file/namespace-overview.html[SchemaDoc]
...
|xref:transports/ftp-transport-reference.adoc[FTP] |https://www.mulesoft.org/docs/site/3.4.0/apidocs/org/mule/transport/ftp-ee/package-summary.html[JavaDoc]http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_ftp-ee/namespace-overview.html[SchemaDoc]
...
|xref:transports/https-transport-reference.adoc[HTTPS] |https://www.mulesoft.org/docs/site/3.4.0/apidocs/org/mule/transport/http/package-summary.html[JavaDoc]http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_https/namespace-overview.html[SchemaDoc]
...
|xref:transports/imap-transport-reference.adoc[IMAPS] |https://www.mulesoft.org/docs/site/3.4.0/apidocs/org/mule/transport/email/package-summary.html[JavaDoc]http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_imaps/namespace-overview.html[SchemaDoc]
...
|xref:transports/jdbc-transport-reference.adoc[JDBC] |https://www.mulesoft.org/docs/site/3.4.0/apidocs/org/mule/transport/jdbc-ee/package-summary.html[JavaDoc]http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_jdbc-ee/namespace-overview.html[SchemaDoc]
...
|xref:transports/jetty-ssl-transport.adoc[Jetty SSL] |https://www.mulesoft.org/docs/site/3.4.0/apidocs/org/mule/transport/jetty/package-summary.html[JavaDoc]http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_jetty%20ssl/namespace-overview.html[SchemaDoc]
...
|xref:transports/multicast-transport-reference.adoc[Multicast] |https://www.mulesoft.org/docs/site/3.4.0/apidocs/org/mule/transport/multicast/package-summary.html[JavaDoc]http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_multicast/namespace-overview.html[SchemaDoc]
...
|xref:transports/pop3-transport-reference.adoc[POP3S] |https://www.mulesoft.org/docs/site/3.4.0/apidocs/org/mule/transport/email/package-summary.html[JavaDoc]http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_pop3s/namespace-overview.html[SchemaDoc]
...
|xref:transports/rmi-transport-reference.adoc[RMI] |https://www.mulesoft.org/docs/site/3.4.0/apidocs/org/mule/transport/rmi/package-summary.html[JavaDoc]http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_rmi/namespace-overview.html[SchemaDoc]
...
|xref:transports/sftp-transport-reference.adoc[SFTP] |https://www.mulesoft.org/docs/site/3.4.0/apidocs/org/mule/transport/sftp/package-summary.html[JavaDoc]http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_sftp/namespace-overview.html[SchemaDoc]
...
|xref:transports/smtp-transport-reference.adoc[SMTPS] |https://www.mulesoft.org/docs/site/3.4.0/apidocs/org/mule/transport/email/package-summary.html[JavaDoc]http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_smtps/namespace-overview.html[SchemaDoc]
...
|xref:transports/stdio-transport-reference.adoc[STDIO] |https://www.mulesoft.org/docs/site/3.4.0/apidocs/org/mule/transport/stdio/package-summary.html[JavaDoc]http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_stdio/namespace-overview.html[SchemaDoc]
...
|xref:transports/ssl-and-tls-transports-reference.adoc[TLS] |https://www.mulesoft.org/docs/site/3.4.0/apidocs/org/mule/transport/ssl/package-summary.html[JavaDoc]http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_tls/namespace-overview.html[SchemaDoc]
...
|xref:transports/vm-transport-reference.adoc[VM] |https://www.mulesoft.org/docs/site/3.4.0/apidocs/org/mule/transport/vm/package-summary.html[JavaDoc]http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_vm/namespace-overview.html[SchemaDoc]
