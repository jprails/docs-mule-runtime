...
The http://en.wikipedia.org/wiki/Multicast[Multicast] transport allow sending messages to or receiving messages from groups of multicast sockets. It is implemented on top of xref:transports/udp-transport-reference.adoc[UDP] and is highly scalable since knowledge of the receivers is not required.
...
https://www.mulesoft.org/docs/site/current/apidocs/org/mule/transport/multicast/package-summary.html[Multicast]
