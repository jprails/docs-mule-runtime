...
|IMAP
|https://www.mulesoft.org/docs/site/current3/apidocs/org/mule/transport/email/package-summary.html[JavaDoc SchemaDoc] |image:transports/check.png[] | - | -  | -  | -  | -  |one-way |one-way |org.mule.transport:mule-transport-imap
|IMAPS |https://www.mulesoft.org/docs/site/current3/apidocs/org/mule/transport/email/package-summary.html[JavaDoc SchemaDoc] |image:transports/check.png[] | -  | -  | -  | -  | -  |one-way |one-way |org.mule.transport:mule-transport-imaps
|===
