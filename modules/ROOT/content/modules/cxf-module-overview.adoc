...
:page-aliases: cxf-module-overview.adoc
...
For information about what standards are supported, see xref:3.7@modules/supported-web-service-standards.adoc[Supported Web Service Standards].
