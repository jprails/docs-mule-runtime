...
[WARNING]
This module provides a "Plug-in" for JBoss jBPM to be used with Mule's BPM support. If you have not yet read the general documentation for Mule's xref:modules/bpm-module-reference.adoc[BPM Support], read that first and then come back to this page.
...
For more configuration options, refer to the http://docs.jboss.org/jbpm/v4/devguide/html_single/#configuration[jBPM documentation] and/or http://docs.jboss.org/hibernate/core/3.6/reference/en-US/html_single/#configuration-xmlconfig[Hibernate documentation].
