...
7 xref:modules/atom-module-reference.adoc[global elements], 1 xref:modules/atom-module-reference.adoc[local element], 5 xref:modules/atom-module-reference.adoc[complexTypes], 1 xref:modules/atom-module-reference.adoc[attribute group]
