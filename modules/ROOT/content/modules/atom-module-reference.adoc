...
link:/docs/site/3.3.0/apidocs/org/mule/module/atom/package-summary.html[atom]
...
* https://cwiki.apache.org/confluence/display/ABDERA/Documentationhttp://cwiki.apache.org/confluence/display/ABDERA/Documentation[Abdera User's Guide]