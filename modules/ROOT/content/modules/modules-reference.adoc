...
|xref:modules/jboss-jbpm-module-reference.adoc[jBPM Module] |http://www.jboss.org/jbpm[JBoss jBPM] is a best-of-breed open source BPMS and is well-integrated with Mule. One advantage of jBPM is that it is embedded directly in the Mule runtime, allowing for faster performance.
...
|OGNL Module |Provides a filter using https://commons.apache.org/proper/commons-ognl/[OGNL] expressions. +
