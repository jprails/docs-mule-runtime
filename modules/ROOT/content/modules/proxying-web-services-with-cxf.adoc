...
[TIP]
To send outbound requests to external web services, it's highly recommended that you use the xref:3.6@connectors::web-service-consumer.adoc[Web Service Consumer] instead.
