...
[NOTE]
When sending requests to an external web service, the recommended approach is to use the xref:3.5@connectors::web-service-consumer.adoc[Web Service Consumer]﻿ rather than the CXF Module.
...
* xref:3.7@modules/cxf-module-overview.adoc[Overview]
* xref:3.6@modules/building-web-services-with-cxf.adoc[Building Web Services]
* xref:3.6@modules/consuming-web-services-with-cxf.adoc[Consuming Web Services]
* xref:3.6@modules/proxying-web-services-with-cxf.adoc[Proxying Web Services]
* xref:3.6@modules/using-http-get-requests.adoc[Using HTTP GET Requests]
* xref:3.3@bookstore-example.adoc[Bookstore Example]
* xref:3.6@modules/cxf-module-configuration-reference.adoc[Configuration Reference]
* xref:3.6@transports/wsdl-connectors.adoc[Using the WSDL Connector]

*Web Service Standards*

* xref:3.7@modules/supported-web-service-standards.adoc[Supported Web Service Standards]
* xref:3.7@modules/using-mtom.adoc[Using MTOM]
* xref:3.6@modules/enabling-ws-addressing.adoc[Enabling WS-Addressing]
* xref:3.6@modules/enabling-ws-security.adoc[Enabling WS-Security]
