...
These transformers support the xref:transformers/transformers-configuration-reference.adoc[standard transformer attributes]. In addition, they support the following configuration.
