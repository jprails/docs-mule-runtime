...
:page-aliases: domtoxml-transformer.adoc
...
These transformers support the xref:3.7@transformers/transformers-configuration-reference.adoc[standard transformer attributes]. In addition, they support the following configuration.
