...
JSON Path can be used in xref:expressions-configuration-reference.adoc[Mule expressions] to query JSON message payloads for filtering or xref:scopes/message-enricher.adoc[enrichment].
