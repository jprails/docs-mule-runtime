...
JSON Path can be used in xref:mel/mule-expression-language-mel.adoc[Mule expressions] to query JSON message payloads for filtering or xref:scopes/message-enricher.adoc[enrichment].
