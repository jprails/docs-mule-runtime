...
:page-aliases: json-module-reference.adoc
...
JSON Path can be used in xref:non-mel-expressions/non-mel-expressions-configuration-reference.adoc[Mule expressions] to query JSON message payloads for filtering or xref:scopes/message-enricher.adoc[enrichment].
