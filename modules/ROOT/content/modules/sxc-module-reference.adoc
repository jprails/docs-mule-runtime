...
:page-aliases: sxc-module-reference.adoc
...
The SXC module contains an outbound router and a filter that use the https://web.archive.org/web/20120523021401/http://sxc.codehaus.org/Home[SXC project] for streaming XPath routing.
...
SXC supports a limited subset of XPath expressions. For details, see the http://sxc.codehaus.org/XPath[SXC documentation].
