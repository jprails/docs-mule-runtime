...
* *Mule 3.2* Flows. Through the queued-asynchronous processing-strategy. See xref:flows/flow-processing-strategies.adoc[Flow Processing Strategies] for more information about the queued-asynchronous processing-strategy.
