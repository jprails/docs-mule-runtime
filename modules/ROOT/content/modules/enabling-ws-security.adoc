...
To the Mule flow that involves a Web service, add a xref:3.6@components/cxf-component-reference.adoc[*CXF Component*] to publish, consume, or proxy a Web service. Complete the following steps to configure WS-security on the SOAP component.
