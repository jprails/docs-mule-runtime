...
If the business logic for your Mule application is relatively simple, you are probably best off implementing it using Mule's orchestration functionality such as xref:message-sources.adoc[flows, routers, and custom components].
