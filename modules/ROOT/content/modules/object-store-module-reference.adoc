...
:page-aliases: object-store-module-reference.adoc
...
[NOTE]
====
To use the object Store module in Anypoint Studio, you must first download the *Object Store Connector* from the xref:2.0@exchange::exchange1.adoc[Anypoint Exchange]. +
...
* xref:object-store::managing-application-data-with-object-stores.adoc[Managing Application Data Storage with Object Stores]