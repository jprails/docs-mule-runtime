...
This page provides reference information about the elements and attributes you can configure for the xref:3.6@modules/cxf-module-reference.adoc[CXF Module Reference].

*Note*: The *enableMuleSoapHeaders* field listed in the following XSLT-generated sections is not currently implemented and has no effect.
