...
:page-aliases: cxf-module-configuration-reference.adoc
...
This page provides reference information about the elements and attributes you can configure for the xref:modules/cxf-module-reference.adoc[CXF Module Reference] .
