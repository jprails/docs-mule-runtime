...
|===
|image:warning.png[(warning)] |These are instructions for running the Widget example in Mule 3.2. To run it in Mile 3.1, see xref:widget-example-mule-3.1.adoc[here].
