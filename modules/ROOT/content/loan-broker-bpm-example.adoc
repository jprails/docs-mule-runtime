...
The Process Engine is an instance of http://www.jboss.org/jbpm[JBoss jBPM] and is configured using defaults as follows. For more information refer to the xref:modules/bpm-module-reference.adoc[BPM Module Reference] documentation.
...
For more information refer to the xref:modules/bpm-module-reference.adoc[BPM Module Reference] documentation and/or the http://docs.jboss.com/jbpm/v4/userguide/html_single/[jBPM User Guide].