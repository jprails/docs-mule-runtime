...
* Adding properties in the configuration files of applications that use shared resources can result in issues, as these properties will be shared with other apps in the domain and there may be conflicts. You can instead xref:administer/setting-environment-variables.adoc[set environment variables].
...
* xref:3.6@connectors::database-connector.adoc[DB]
* xref:transports/jms-transport-reference.adoc[JMS]
*  xref:3.6@connectors::http-connector.adoc[HTTP Connector]
