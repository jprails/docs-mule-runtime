...
:page-aliases: shared-resources.adoc
...
* Adding properties in the configuration files of applications that use shared resources can result in issues, as these properties are shared with other apps in the domain and there may be conflicts. You can instead xref:administer/setting-environment-variables.adoc[set environment variables].
...
+
image::shared-resources/new-domain.png[new+domain]
+
. Fill in the same fields as you would with a regular Mule Project:
+
image::shared-resources/create-new-domain.png[create+new+domain]
+
...
image::shared-resources/domain-folders.png[]
...
image::shared-resources/design-source.png[design+source]
...
image::shared-resources/assign-domain.png[assign+domain]
...
[source,xml,linenums]
----
include::{samplesdir}/shared-resources_01.xml[]
----
...
image::shared-resources/pick-resource.png[pick+resource]
...
image::shared-resources/run-configurations-1.png[run+configurations+1]
...
image::shared-resources/run-configuration-3.png[run+configuration+3]
...
+
image::shared-resources/export.png[]
+
[NOTE]
====
...
image::shared-resources/domainbundle.png[domainBundle]
...
[source,xml,linenums]
----
include::{samplesdir}/shared-resources_02.xml[]
----
...
[source,xml,linenums]
----
include::{samplesdir}/shared-resources_03.xml[]
----
...
[source,xml,linenums]
----
include::{samplesdir}/shared-resources_04.xml[]
----
...
[source,xml,linenums]
----
include::{samplesdir}/shared-resources_05.xml[]
----
...
[source,xml,linenums]
----
include::{samplesdir}/shared-resources_06.xml[]
----
...
[source,xml,linenums]
----
include::{samplesdir}/shared-resources_07.xml[]
----

=== TLS Context

Share xref:3.8@connectors::tls-configuration.adoc[TLS configurations] allows shared <<HTTP,listener configurations>> to use the same TLS configuration. +
...
[source,xml,linenums]
----
include::{samplesdir}/shared-resources_08.xml[]
----
...
[source,xml,linenums]
----
include::{samplesdir}/shared-resources_09.xml[]
----
...
[source,xml,linenums]
----
include::{samplesdir}/shared-resources_10.xml[]
----
...
[source,xml,linenums]
----
include::{samplesdir}/shared-resources_11.xml[]
----
...
* Note that although shared resources is limited to the selected connectors and libraries covered in this document, there are ways to share other configuration fragments in Mule. Refer to xref:shared-resources/sharing-custom-configuration-fragments.adoc[Sharing Custom Configuration Fragments] for details.
...
* xref:3.8@connectors::database-connector.adoc[DB]
* xref:transports/jms-transport-reference.adoc[JMS]
* xref:3.8@connectors::http-connector.adoc[HTTP Connector]
* xref:transports/mule-wmq-transport-reference.adoc[WMQ]
* xref:modules/jboss-transaction-manager-reference.adoc[JBoss]
* xref:administer/setting-environment-variables.adoc[Set Environment Variables]