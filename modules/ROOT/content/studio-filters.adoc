...
|image:filter-24x16.png[Filter-24x16] |Message |Applies specified criteria to a message to determine whether it should be processed |xref:filters/message-property-filter.adoc[Message Filter Reference]
...
|image:filter-24x16.png[Filter-24x16] |Schema Validation |Uses the JAXP libraries, to validate a message against a schema. |xref:filters/schema-validation-filter.adoc[Schema Validation Filter Reference]
