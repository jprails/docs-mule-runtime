...
[TIP]
This document assumes the reader is familiar with the DataMapper Transformer. Consult the xref:6@studio::datamapper/datamapper-user-guide-and-reference.adoc[DataMapper Transformer Reference] for details.
