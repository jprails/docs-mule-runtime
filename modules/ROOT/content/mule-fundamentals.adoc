...
* http://www.youtube.com/watch?v=OtchRiDHHwo[2 Minute Intro to Mule]
* https://www.mulesoft.com/webinars/api/mule-101-anypoint-platform-overview[Mule 101]
* http://www.mulesoft.com/webinars/esb/building-and-deploying-integration-application[Mule 201]
* http://www.mulesoft.com/training/virtual-course-mule-esb-fundamentals-form[Free Training]