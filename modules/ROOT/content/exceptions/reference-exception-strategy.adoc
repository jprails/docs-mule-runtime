...
. If you have not already done so, create a *global* xref:3.6@exceptions/catch-exception-strategy.adoc[catch], xref:3.7@exceptions/rollback-exception-strategy.adoc[rollback], or xref:3.7@exceptions/choice-exception-strategy.adoc[choice] exception strategy to which your reference exception strategy can refer.
