...
. If you have not already done so, create a configuration file as described in the xref:exceptions/catch-exception-strategy.adoc[catch], xref:exceptions/rollback-exception-strategy.adoc[rollback], or xref:exceptions/choice-exception-strategy.adoc[choice] exception strategy to which your reference exception strategy can refer.
