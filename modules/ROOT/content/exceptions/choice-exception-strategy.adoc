...
+
image::exceptions/choice-1.png[choice+1]
+
...
+
image::exceptions/choice-2.png[choice+2]
+
...
+
image::exceptions/choice-3.png[choice+3]
...
You can create one or more xref:error-handling.adoc#creating-a-global-default-exception-strategy[global exception strategies] to reuse in flows throughout your Mule project. First, create a global choice exception strategy, then add a xref:exceptions/reference-exception-strategy.adoc[*Reference Exception Strategy*] to a flow to apply the error handling behavior of your new global choice exception strategy.
...
+
image::exceptions/choice-4.png[choice+4]
+
...
+
image::exceptions/reference-1.png[reference+1]
+
. Open the Reference Exception Strategy's *Properties Editor*.
+
image::exceptions/choice-setup-choice.png[choice+setup+choice]
+
