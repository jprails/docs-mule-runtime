...
* A xref:transactions/transaction-management.adoc[Transactional Scope] may include its own exception strategy, regardless of what you define at Flow level.

== Examples

image::exceptions/mule-exception-strategies.png[]

[source,xml,linenums]
----
include::{samplesdir}/mule-exception-strategies.xml[]
----
